...
par(new=T)
plot(rdate[1225],central_bloom_med_hgt,ylim=c(0,100),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))
par(new=T)
plot(rdate[1225],central_bloom_min_hgt,ylim=c(0,100),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))   
par(new=T)
plot(rdate[1225],central_bloom_max_hgt,ylim=c(0,100),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))        
segments(rdate[1225],central_bloom_max_hgt,rdate[1225],central_bloom_min_hgt)
par(new=T)

plot(rdate[1227],centralIND_bloom_med_hgt,ylim=c(0,100),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")), col='darkgrey',
     ylab=expression(paste('ng l'^-1)))
par(new=T)
plot(rdate[1227],centralIND_bloom_min_hgt,ylim=c(0,100),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),col='darkgrey',
     ylab=expression(paste('ng l'^-1)))   
par(new=T)
plot(rdate[1227],centralIND_bloom_max_hgt,ylim=c(0,100),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),col='darkgrey',
     ylab=expression(paste('ng l'^-1)))   
segments(rdate[1227],centralIND_bloom_max_hgt,rdate[1227],centralIND_bloom_min_hgt,col='darkgrey')


plot(rdate[1214:1285], mod_sud_mean,  ylim=c(0,100),xlab='',ylab='',type='l',col='#82012099',
     xlim=as.Date(c("2001-01-01", "2006-12-31"), "%Y-%m-%d"))
polygon(xx,SS, col='#82012066',border = NA)
par(new=T)
plot(rdate[1225],south_bloom_med_hgt,ylim=c(0,100),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))
par(new=T)
plot(rdate[1225],south_bloom_min_hgt,ylim=c(0,100),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))   
par(new=T)
plot(rdate[1225],south_bloom_max_hgt,ylim=c(0,100),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))   
...
par(new=T)
plot(rdate[1225],nord_bloom_med_mhgt, ylim=c(0,0.4),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))
par(new=T)
plot(rdate[1225],nord_bloom_min_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))   
par(new=T)
plot(rdate[1225],nord_bloom_max_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))        
segments(rdate[1225],nord_bloom_max_mhgt,rdate[1225],nord_bloom_min_mhgt)
  

plot(rdate[1214:1285], mod_cent_mean_mhgt,  ylim=c(0,0.4),xlab='',ylab='',type='l',col='#d1740c99',
     xlim=as.Date(c("2001-01-01", "2006-12-31"), "%Y-%m-%d"))
polygon(xx,CC_mhg, col='#fed97666',border = NA)
par(new=T)
plot(rdate[1225],central_bloom_med_mhgt, ylim=c(0,0.4),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))
par(new=T)
plot(rdate[1225],central_bloom_min_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))   
par(new=T)
plot(rdate[1225],central_bloom_max_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))        
segments(rdate[1225],central_bloom_max_mhgt,rdate[1225],central_bloom_min_mhgt)
par(new=T)

plot(rdate[1227],centralIND_bloom_med_mhgt, ylim=c(0,0.4),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")), col='darkgrey',
     ylab=expression(paste('ng l'^-1)))
par(new=T)
plot(rdate[1227],centralIND_bloom_min_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),col='darkgrey',
     ylab=expression(paste('ng l'^-1)))   
par(new=T)
plot(rdate[1227],centralIND_bloom_max_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),col='darkgrey',
     ylab=expression(paste('ng l'^-1)))   
segments(rdate[1227],centralIND_bloom_max_mhgt,rdate[1227],centralIND_bloom_min_mhgt,col='darkgrey')


plot(rdate[1214:1285], mod_sud_mean_mhgt,  ylim=c(0,0.4),xlab='',ylab='',type='l',col='#820120',
     xlim=as.Date(c("2001-01-01", "2006-12-31"), "%Y-%m-%d"))
polygon(xx,SS_mhg, col='#82012066',border = NA)
par(new=T)
plot(rdate[1225],south_bloom_med_mhgt, ylim=c(0,0.4),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))
par(new=T)
plot(rdate[1225],south_bloom_min_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))   
par(new=T)
plot(rdate[1225],south_bloom_max_mhgt, ylim=c(0,0.4),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2006-12-31")),
     ylab=expression(paste('ng l'^-1)))   
