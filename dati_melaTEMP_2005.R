...
plot(X[23]$C01.MESE,X[23]$C01.TEMP, type='b')




png('DatiMElaTEMP2005.png',width=29, height = 21, units='cm',res=200) 
par(mfrow=c(6,3), mar=c(2.6,2,1,1),oma=c(0,0,4.3,0), cex.axis=1.2)


plot(as.POSIXct.Date(mod_b01[,1]), mod_b02[,2],
     ylim=c(0,35),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#00000055')
par(new=T)
plot(B01$B01.Data,B01$B01.TEMP, type='b',lwd=2,
     ylab='*C',xlab = '',
     ylim=c(0,35),col='tomato', pch=8)
mtext('St. B01, nodo 3765',3)
#text(B01$B01.MESE,B01$B01.TEMP,labels=B01$B01.TEMP)
mtext("Temperatura", 3, outer = TRUE, line=1.8, cex=2,
      font=2)

plot(as.POSIXct.Date(mod_b02[,1]), mod_b02[,2],ylim=c(0,35),ylab='*C',xlab = '',
     xaxt='n',pch=19,col='#00000055')
par(new=T)
plot(B02$B02.MESE,B02$B02.TEMP, type='b',ylim=c(0,35),lwd=2, ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b03[,1]), mod_b03[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B03$B03.MESE,B03$B03.TEMP, type='b',ylim=c(0,35),lwd=2, ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b04[,1]), mod_b04[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B04$B04.MESE,B04$B04.TEMP, type='b',lwd=2,ylim=c(0,35), ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b06[,1]), mod_b06[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B06$B06.MESE,B06$B06.TEMP, type='b',
...
plot(as.POSIXct.Date(mod_b07[,1]), mod_b07[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B07$B07.MESE,B07$B07.TEMP, lwd=2,type='b',ylim=c(0,35), ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b08[,1]), mod_b08[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B08$B08.MESE,B08$B08.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b09[,1]), mod_b09[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B09$B09.MESE,B09$B09.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b10[,1]), mod_b10[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B10$B10.MESE,B10$B10.TEMP, type='b',lwd=2,
        ylim=c(0,35), ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b11[,1]), mod_b11[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B11$B11.MESE,B11$B11.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b14[,1]), mod_b14[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B14$B14.MESE,B14$B14.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b16[,1]), mod_b16[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B16$B16.MESE,B16$B16.TEMP, type='b',lwd=2,ylim=c(0,35), ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b17[,1]), mod_b17[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B17$B17.MESE,B17$B17.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b19[,1]), mod_b19[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B19$B19.MESE,B19$B19.TEMP, type='b',ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b20[,1]), mod_b20[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B20$B20.MESE,B20$B20.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_b31[,1]), mod_b31[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(B31$B31.MESE,B31$B31.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_CI[,1]), mod_CI[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(CI$CI.MESE,CI$CI.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
...
plot(as.POSIXct.Date(mod_CS[,1]), mod_CS[,2],
     ...
     xaxt='n',col='#00000055')
par(new=T)
plot(CS$CS.MESE,CS$CS.TEMP, type='b',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='tomato', pch=8)
