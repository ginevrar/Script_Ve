...
segments(rdate[105],0,rdate[105],max(hg$dsn1[52:122]),lty=2, col=1, lwd=1)
...
segments(rdate[104],0,rdate[104],max(mehg$dsn1[52:122]),lty=2, col='#e60073', lwd=1) #abline(v=rdate[92],col='#e60073', lty=2)
a<-seq(0,.4, by=.1)
...
polygon(H_resus,yy1, col='#68676755',border = NA)
polygon(Eutrop,yy1, col='#3a871f88',border = NA)
segments(rdate[122],0,rdate[122],max(hg$dsn2[52:122]),lty=2, col=1, lwd=1)
...
plot(rdate[52:122],mehg$dsn2[52:122], yaxt='n',
     ...
     lwd=2,main=' ',lty=1,
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
segments(rdate[122],0,rdate[122],max(mehg$dsn2[52:122]),lty=2, col='#e60073', lwd=1)
par(new=T)
...
plot(rdate[52:122],hg$dsn4[52:122],ylim=c(0,700),
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
segments(rdate[105],0,rdate[105],max(hg$dsn4[52:122]),lty=2, lwd=1,col=1)

par(new=T)
plot(rdate[52:122],hg$osn4[52:122],
     type='l', col=1, ylab=' ',ylim=c(0,700),
     lwd=2,main=' ',lty=2,yaxt='n',
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
a<-seq(0,700, by=350)
axis(2,at=a, cex.axis=.9,las=2)
par(new=T)
...
segments(rdate[98],0,rdate[98],max(mehg$dsn4[52:122]),lty=2, lwd=1,col='#e60073')
par(new=T)
plot(rdate[52:122],mehg$osn4[52:122],yaxt='n',
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
text(rdate[63],3,'1971',col='#e60073')
#segments(rdate[93],0,rdate[93],max(mehg$sn4[52:122]),lty=2, lwd=1,col='#e60073')
a<-seq(0,1, by=0.2)
axis(4,at=a, cex.axis=.9,col='#e60073', las=2)
...
plot(rdate[52:122],hg$osn3[52:122],ylim = c(0,600),
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
segments(rdate[122],0,rdate[122],max(hg$dsn3[52:122]),lty=2, lwd=1,col=1)
...
plot(rdate[52:122],mehg$osn3[52:122],
     ...
     lwd=2,main=' ',lty=2,ylim=c(0,1),
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
segments(rdate[92],0,rdate[92],max(mehg$dsn3[52:122]),lty=2, lwd=1,col='#e60073')
a<-seq(0,1, by=.2)
axis(4,at=a, cex.axis=.9, col='#e60073',las=2)
...
a<-seq(0,600, by=300)
axis(2,at=a, cex.axis=.9, las=2)
segments(rdate[93],0,rdate[93],max(hg$dsn5[52:122]),lty=2, lwd=1,col=1)
...
segments(rdate[93],0,rdate[93],max(mehg$dsn5[52:122]),lty=2, lwd=1,col='#e60073')
...
plot(rdate[52:122],hg$osc6[52:122],ylim = c(0,1500),
     ...
     lwd=2,main=' ',lty=3,yaxt='n',
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
segments(rdate[91],0,rdate[91],max(hg$dsc6[52:122]),lty=2, lwd=1,col=1)
...
plot(rdate[52:122],mehg$dsc6[52:122],yaxt='n',
     ...
     lwd=2,main=' ',lty=1,
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
segments(rdate[91],0,rdate[91],max(mehg$dsc6[52:122]),lty=2, lwd=1,col='#e60073')
...
a<-seq(0,200, by=100)
axis(2,at=a, cex.axis=.9, las=2)
segments(rdate[92],0,rdate[92],max(hg$dsc7[52:122]),lty=2, lwd=1,col=1)
...
text(rdate[88],.5,'1991',col='#e60073')
 segments(rdate[122],0,rdate[122],max(mehg$dsc7[52:122]),lty=2, lwd=1,col='#e60073')
 a<-seq(0,.1, by=.05)
 axis(4,at=a, cex.axis=.9, col='#e60073', las=2)

yy6<-c(0, 0, 650, 650)
plot(rdate[52:122],hg$dss8[52:122],
     type='l', col=1, ylab=' ',ylim=c(0,200),
...
segments(rdate[122],0,rdate[122],max(hg$dss8[52:122]),lty=2, lwd=1,col=1)
text(rdate[102],490,'1995',col=1)
par(new=T)
plot(rdate[52:122],hg$oss8[52:122],
     type='l', col=1, ylab=' ',ylim=c(0,200),
     lwd=2,main='Box8',lty=2,yaxt='n',
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=.9)
a<-seq(0,200, by=100)
axis(2,at=a, cex.axis=.9, las=2)
par(new=T)
...
segments(rdate[104],0,rdate[104],max(hg$dss9[52:122]),lty=2, lwd=1,col=1)
segments(rdate[72],490,rdate[72],440, col=1, lwd=2)
segments(rdate[71],460,rdate[72],440, col=1, lwd=2)
segments(rdate[72],440,rdate[73],460, col=1, lwd=2)
par(new=T)
...
segments(rdate[92],0,rdate[92],max(hg$dss10[52:122]),lty=2, lwd=1,col=1)
