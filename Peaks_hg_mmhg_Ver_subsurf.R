...
plot(rdate[52:122],mehg$sn1[52:122],
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
par(new=T)
plot(rdate[52:122],mehg$dsn1[52:122],
     type='l', col='#e60073',ylim=c(0,2), ylab='MeHg (ng/g)',
...
plot(rdate[52:122],hg$sn4[52:122],
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
par(new=T)
plot(rdate[52:122],hg$dsn4[52:122],
     type='l', col=1, ylab=' ',
...
plot(rdate[52:122],hg$sn3[52:122],
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
par(new=T)
plot(rdate[52:122],hg$dsn3[52:122],
     type='l', col=1, ylab=' ',
     lwd=2,main=' ',lty=2,yaxt='n',
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
par(new=T)
plot(rdate[52:122],hg$osn3[52:122],
     type='l', col=1, ylab=' ',
     lwd=2,main=' ',lty=3,yaxt='n',
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
...
plot(rdate[52:122],mehg$sn3[52:122],
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
par(new=T)
plot(rdate[52:122],mehg$dsn3[52:122],
...
plot(rdate[52:122],hg$sc6[52:122],
     ...
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
par(new=T)
plot(rdate[52:122],hg$dsc6[52:122],
     type='l', col=1, ylab=' ',
     lwd=2,main=' ',lty=2,yaxt='n',
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
par(new=T)
plot(rdate[52:122],hg$osc6[52:122],
     type='l', col=1, ylab=' ',
     lwd=2,main=' ',lty=3,yaxt='n',
     xlab= '', cex.lab=1 , cex.main=1 , cex.axis=1)
