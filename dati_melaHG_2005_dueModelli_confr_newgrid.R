...
mod_b01<-read.table('252.2d.1')   
mod_b02<-read.table('252.2d.2')   
mod_b03<-read.table('252.2d.3')   
mod_b04<-read.table('252.2d.4')   
mod_b05<-read.table('252.2d.5')   
mod_b06<-read.table('252.2d.6')   
mod_b07<-read.table('252.2d.7')   
mod_b08<-read.table('252.2d.8')   
mod_b09<-read.table('252.2d.9')   
mod_b10<-read.table('252.2d.10')   
mod_b11<-read.table('252.2d.11')   
mod_b12<-read.table('252.2d.12')   
mod_b13<-read.table('252.2d.13')   
mod_b14<-read.table('252.2d.14')   
mod_b15<-read.table('252.2d.15')   
mod_b16<-read.table('252.2d.16')   
mod_b17<-read.table('252.2d.17')   
mod_b18<-read.table('252.2d.18')   
mod_b19<-read.table('252.2d.19')   
mod_b20<-read.table('252.2d.20')   
mod_b31<-read.table('252.2d.21')   
mod_CI<-read.table('252.2d.22')   
mod_CS<-read.table('252.2d.23')   
#versione nodi venlag64
setwd('C:/Users/gi/Desktop/shyfem68_merc/File_hydro/lag64_simB')
mod2_b01<-read.table('252.2d.1')   
mod2_b02<-read.table('252.2d.2')   
mod2_b03<-read.table('252.2d.3')   
mod2_b04<-read.table('252.2d.4')   
mod2_b06<-read.table('252.2d.5')
mod2_b07<-read.table('252.2d.7')   
mod2_b08<-read.table('252.2d.8')   
mod2_b09<-read.table('252.2d.9')   
mod2_b10<-read.table('252.2d.10')   
mod2_b11<-read.table('252.2d.11')   
mod2_b14<-read.table('252.2d.12')   
mod2_b16<-read.table('252.2d.13')   
mod2_b19<-read.table('252.2d.14')   
mod2_b20<-read.table('252.2d.15')   
mod2_b31<-read.table('252.2d.16')   
mod2_CI<-read.table('252.2d.17')   
mod2_CS<-read.table('252.2d.18')   
#mod2_b19<-read.table('252.2d.19')   
#mod2_b20<-read.table('252.2d.20')   
#mod2_b31<-read.table('252.2d.21')   
#mod2_CI<-read.table('252.2d.22')   
#mod2_CS<-read.table('252.2d.23')   

datiM2005<-subset(datiM,ANNO==2005)
str(datiM2005)
summary(datiM2005)

dif_hg_b01<-(mod_b01[,2]-mod2_b01[,2])/mod_b01[,2]*100
dif_hg_b02<-(mod_b02[,2]-mod2_b02[,2])/mod_b02[,2]*100
dif_hg_b03<-(mod_b03[,2]-mod2_b03[,2])/mod_b03[,2]*100
dif_hg_b04<-(mod_b04[,2]-mod2_b04[,2])/mod_b04[,2]*100
dif_hg_b05<-(mod_b05[,2]-mod2_b05[,2])/mod_b05[,2]*100
dif_hg_b06<-(mod_b06[,2]-mod2_b06[,2])/mod_b06[,2]*100
dif_hg_b07<-(mod_b07[,2]-mod2_b07[,2])/mod_b07[,2]*100
dif_hg_b08<-(mod_b08[,2]-mod2_b08[,2])/mod_b08[,2]*100
dif_hg_b09<-(mod_b09[,2]-mod2_b09[,2])/mod_b09[,2]*100
dif_hg_b10<-(mod_b10[,2]-mod2_b10[,2])/mod_b10[,2]*100
dif_hg_b11<-(mod_b11[,2]-mod2_b11[,2])/mod_b11[,2]*100
dif_hg_b14<-(mod_b14[,2]-mod2_b12[,2])/mod_b12[,2]*100
dif_hg_b16<-(mod_b16[,2]-mod2_b16[,2])/mod_b16[,2]*100
dif_hg_b19<-(mod_b19[,2]-mod2_b19[,2])/mod_b19[,2]*100
dif_hg_b20<-(mod_b20[,2]-mod2_b20[,2])/mod_b20[,2]*100
dif_hg_b31<-(mod_b31[,2]-mod2_b31[,2])/mod_b31[,2]*100

SILDif_mela<-c(dif_sil_b01, dif_sil_b02,dif_sil_b03,dif_sil_b04,dif_sil_b05,dif_sil_b06,dif_sil_b07,
               dif_sil_b08,dif_sil_b09,dif_sil_b10,dif_sil_b11,dif_sil_b16,
               dif_sil_b19,dif_sil_b20,
               dif_sil_b31)
...
png('DatiMEla_HG_model_GRIGLIE_ireib5_2_sim3233VV.png',width=29, height = 21, units='cm',res=200) 
...
par(new=T)
plot(B01$B01.Data,B01$B01.hg*10^3,cex=1.5, type='p',lwd=2,
     ylab='*C',xlab = '',
     ylim=c(0,40),col='#00000099', pch=19)
...
legend(B01$B01.Data[1],140, pch=19,lty=c(2,1,2,4),
...
plot(as.POSIXct.Date(mod2_b02[,1]), mod2_b02[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B02$B02.Data,B02$B02.hg*1000,cex=1.5, type='p',ylim=c(0,40),lwd=2, ylab='*C',xlab = '',
     col='#00000099', pch=19)
mtext('St. B02, nodo 4036',3)

plot(as.POSIXct.Date(mod_b03[,1]), mod_b03[,2],
     ylim=c(0,60),pch=19,ylab='*C',xlab = '',type='l',lwd=2,
     xaxt='n',col='#005E8C')
par(new=T)
plot(as.POSIXct.Date(mod2_b03[,1]), mod2_b03[,2],type='l',lwd=2,lty=4,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B03$B03.Data,B03$B03.hg*1000,cex=1.5, type='p',ylim=c(0,60),lwd=2, ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b04[,1]), mod2_b04[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B04$B04.Data,B04$B04.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,60), ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b06[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B06$B06.Data,B06$B06.hg*1000,cex=1.5, type='p',
...
plot(as.POSIXct.Date(mod2_b07[,1]), mod2_b07[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B07$B07.Data,B07$B07.hg*1000,cex=1.5, lwd=2,type='p',
     ylim=c(0,30), ylab='*C',xlab = '',
     col='#00000099', pch=19)
ztext('St. B07, nodo 2904',3)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b08[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B08$B08.Data,B08$B08.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,60),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b09[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B09$B09.Data,B09$B09.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,30),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b10[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B10$B10.Data,B10$B10.hg*1000,cex=1.5, type='p',lwd=2,
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b11[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B11$B11.Data,B11$B11.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,60),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]),mod2_b14[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B14$B14.Data,B14$B14.hg*1000,cex=1.5, type='p',lwd=2,
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b16[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B16$B16.Data,B16$B16.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,30), ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod_b17[,1]), mod_b17[,2],
     ...
     xaxt='n',col='#005E8C',type='l')
par(new=T)
plot(as.POSIXct.Date(mod2_b17[,1]), mod2_b17[,2],type='l',lwd=2,lty=2,
     ylim=c(0,30),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='darkorange')
par(new=T)
plot(B17$B17.Data,B17$B17.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,30),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod_b19[,1]), mod_b19[,2],
     ...
     xaxt='n',col='#005E8C',type='l')
par(new=T)
plot(as.POSIXct.Date(mod2_b18[,1]), mod2_b18[,2],type='l',lwd=2,lty=2,
     ylim=c(0,30),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='darkorange')
par(new=T)
plot(B19$B19.Data,B19$B19.hg*1000,cex=1.5, type='p',ylim=c(0,30),
     ylab='*C',xlab = '',lwd=1.5,
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b20[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B20$B20.Data,B20$B20.hg*1000,cex=1.5, type='p',lwd=2,
     ylim=c(0,40),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b31[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B31$B31.Data,B31$B31.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,140),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_CI[,1]), mod2_CI[,2],type='l',
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(CI$CI.Data,CI$CI.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,35),
     ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_CS[,1]), mod2_CS[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(CS$CS.Data,CS$CS.hg*1000,cex=1.5, type='p',lwd=2,ylim=c(0,30),ylab='*C',xlab = '',
     col='#00000099', pch=19)
