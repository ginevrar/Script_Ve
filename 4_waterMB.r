...
setwd('C:/Users/Ginevra/Dropbox/2017_Venice/105/b')
...
depo_Phg_kg_y 		<-sed_bal$Hg_depo
res_Phg_kg_y 		  <-sed_bal$Hg_res
...
Input_terms<-(river_hg+atm_hg+hg_inflow_kg_y_media+diffusion_kg_y_media+veCity); str(Input_terms); 
