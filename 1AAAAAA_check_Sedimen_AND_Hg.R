...
kdsilt<-1.5*10^5; kdPOM<-2*10^5; ksilt<-1
...
hgbal_1 <-(hgpom_dep1+hgsilt_dep1) - (hgpom_res1+hgsilt_res1)#ug/m2d
hgbal_2 <-(hgpom_dep2+hgsilt_dep2) - (hgpom_res2+hgsilt_res2)#ug/m2d
hgbal_3 <-(hgpom_dep3+hgsilt_dep3) - (hgpom_res3+hgsilt_res3)#ug/m2d
hgbal_4 <-(hgpom_dep4+hgsilt_dep4) - (hgpom_res4+hgsilt_res4)#ug/m2d
hgbal_5 <-(hgpom_dep5+hgsilt_dep5) - (hgpom_res5+hgsilt_res5)#ug/m2d
hgbal_6 <-(hgpom_dep6+hgsilt_dep6) - (hgpom_res6+hgsilt_res6)#ug/m2d
hgbal_7 <-(hgpom_dep7+hgsilt_dep7) - (hgpom_res7+hgsilt_res7)#ug/m2d
hgbal_8 <-(hgpom_dep8+hgsilt_dep8) - (hgpom_res8+hgsilt_res8)#ug/m2d
hgbal_9 <-(hgpom_dep9+hgsilt_dep9) - (hgpom_res9+hgsilt_res9)#ug/m2d
hgbal_10<-(hgpom_dep10+hgsilt_dep10) - (hgpom_res10+hgsilt_res10)#ug/m2d
...
Net_kgy<-(Tot_Depo_hg-Tot_res_hg)*365/10^9
# Ok netto 

plot(Tot_Depo_hg)

plot(rdate,Net_kgy, col='#E28DA8', type='l', lwd=3)
par(new=T)
plot(rdate,cumsum(Net_kgy), col='#B9FF73',type='l', lwd=3, yaxt='n')
axis(side = 4, at=suss)
suss<-seq(150,-350, -50)
