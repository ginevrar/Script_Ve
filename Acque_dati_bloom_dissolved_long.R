...
plot(rdate, mod_nord_mean,  ylim=c(0,250),xlab='',ylab='',type='l',col='royalblue',
     main='Northern Water', xlim=as.Date(c("1900-01-01", "2100-12-01"), "%Y-%m-%d"))
polygon(xx,NN, col='#4575b455',border = NA)
par(new=T)
plot(rdate[1225],nord_bloom_med_hgt,ylim=c(0,250),
     pch=19,xaxt='n',type='p',cex=2,xlab='',xlim=as.Date(c("1900-01-01", "2100-12-01")), yaxt='n')
par(new=T)
plot(rdate[1225],nord_bloom_min_hgt,ylim=c(0,250),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("1900-01-01", "2100-12-01")),yaxt='n')   
par(new=T)
plot(rdate[1225],nord_bloom_max_hgt,ylim=c(0,250),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("1900-01-01", "2100-12-01")),yaxt='n')
...
p2<-plot(rdate, mod_cent_mean,  ylim=c(0,250),xlab='',ylab='',type='l',col='#d1740c99',yaxt='n',
         xlim=as.Date(c("1900-01-01", "2100-12-01"), "%Y-%m-%d"),
         main='Central Water')
polygon(xx,CC, col='#fed97666',border = NA)
par(new=T)
plot(rdate[1225],central_bloom_med_hgt,ylim=c(0,250),pch=19,xaxt='n',type='p',cex=2,xlab='',yaxt='n',
...
p3<-plot(rdate, mod_sud_mean,  ylim=c(0,250),xlab='',ylab='',type='l',col='#82012099',yaxt='n',
         xlim=as.Date(c("1900-01-01", "2100-12-01")), main='Southern Water')
