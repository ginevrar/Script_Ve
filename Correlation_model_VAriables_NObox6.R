...
cor.test(hg_layerA,OM_layerA)       #hg - OM: 0.54  --> 0.41
cor.test(mehg_layerA,OM_layerA)     #hg - OM: 0.56 --< .48
cor.test(hg_layerA,mehg_layerA)     #hg - mehg: 0.92 -->.79
cor.test(hg_layerA,silt_layerA)     #hg - silt: 0.32.--< 0.58
cor.test(mehg_layerA,silt_layerA)     #hg - mehg: 0.27-->0.42
cor.test(mehg_layerA,OM_water)     # mehg - OM w: 0. 17--> -.01

cor.test(hg_layerA_70_90,burial_layerA_70_90)   
#hg -bur r=0.25 --< 0.32  anni 70 - 90 p<0.05
cor.test(hg_layerA_90_2002,burial_layerA_90_2002)   #hg -bur 0.2
plot(hg_layerA_90_2002,burial_layerA_90_2002)   #hg -bur 0.2
...
cor.test(mehg_layerA,OM_layerA) # mehg-om tutto 0.56 -->.48
cor.test(hg_layerA,OM_layerA) # hg-om tutto 0.53 -->.41
