...
setwd('D:\\REf_long')
  ...
  TOTs_19<-TOTs[1251764:1262275,1:11]
  ...
  mean(out3_kgy_mhg+Sb3_kgy_mhg)+mean(out7_kgy_mhg+Sb7_kgy_mhg)+  mean(out10_kgy_mhg+Sb10_kgy_mhg)
