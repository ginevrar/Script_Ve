...
barplot(perctutt, beside=F, width = 10,space=1,legend.text=F,
        border = NA, col=c('cyan3','royalblue','orange',
                           'grey40'),ylim=c(0,110),
        main='Hg inputs to the Venice Lagoon')
...
par(new=T)
plot(years,de2_g_km2_y, type='l', ylim=c(1,26),lwd=2,lty=1, col='#117733', xlab='year',ylab=' ')  ## range 2 - 25 g km-2 y-1 over marine areas (UNEP, 2013)
par(new=T)
plot(years,de3_g_km2_y, type='l', ylim=c(1,26),lwd=2, lty=1,col='#0b70a3', xlab='year',ylab=' ')  ## range 2 - 25 g km-2 y-1 over marine areas (UNEP, 2013)
par(new=T)
plot(years,de4_g_km2_y, type='l', ylim=c(1,26),lwd=2,lty=1, col='#DDCC77', xlab='year',ylab=' ')  ## range 2 - 25 g km-2 y-1 over marine areas (UNEP, 2013)
par(new=T)
plot(years,de5_g_km2_y, type='l', ylim=c(1,26),lwd=2,lty=1, col='#882255', xlab='year',
     ylab='')  ## range 2 - 25 g km-2 y-1 over marine areas (UNEP, 2013)
par(new=T)
plot(years,dep_g_km2_y, type='l', ylim=c(1,26),lwd=2.5, col='cyan3', xlab='year',ylab=' ')  ## range 2 - 25 g km-2 y-1 over marine areas (UNEP, 2013)
#text(18,5,'input for \n the Venice lagoon', cex=1.2)
text(years[10],26,'C', cex=2.5)
