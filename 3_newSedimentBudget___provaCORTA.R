...
POM_depo_m_h<-.5/24   #depo m d-1/24 = m h-1
...
n1<-depo1b_Phg_ug_h-res1_Phg_ug_h
n2<-depo2b_Phg_ug_h-res2_Phg_ug_h
n6<-depo6b_Phg_ug_h-res6_Phg_ug_h
n1<-depo1b_Phg_ug_h-res1_Phg_ug_h
...
plot(rowSums(DEP_ugh-REs_ugh)/10^9*365)
head(rowSums(DEP_ugh-REs_ugh)/10^9*24*365)

netttt<-(rowSums(DEP_ugh-REs_ugh)/10^9*365)

netttt[121]
REs_ugh_all<-rowSums(REs_ugh)

REs_kgy<-REs_ugh_all/10^9*24*365   # (kg h-1)
DEP_kgy<-DEP_ugh_all/10^9*24*365   #kg h-1


head(DEP_ugh_all/10^9*24)   # kg d-1
head(REs_ugh_all/10^9*24)   # kg d-1
...
plot(netto2/10^9)    #kg h-1

head(netto2/10^9*365)
...
a<-((DEP_ugh-REs_ugh)/10^9)   #  (kg h-1)
plot(rdate,a[,1]*365*24,type='l')
...
plot(DEP_ugh[,7]/10^9*24,type='l',col='darkgreen',ylim=c(0,8))
par(new=T)
plot(REs_ugh[,7]/10^9*24,type='l',col='red',ylim=c(0,8))


aaa<-head(DEP_ugh[,7]/10^9*24)
bbb<-head(REs_ugh[,7]/10^9*24)
ccc<-aaa-bbb
ccc*365



head(REs_ugh[,7]/10^9*24)
head(REs_ugh[,6]/10^9*24)

str(DEP_ugh)
str(REs_ugh)

n_ugh<-DEP_ugh-REs_ugh
...
plot(n_ugh_b1*24*365/10^9)
head(n_ugh_b1*24*365/10^9)
plot(n_ugh_b2)
plot(n_ugh_b3)
plot(n_ugh_b4)
plot(n_ugh_b5)
...
res1D_Phg_ug_m2_h<- res_media1B*SEDhg$sn1*TOTs$sn1
res1E_Phg_ug_m2_h<- res_media1*SEDhg$sn1*(silts$sn1+POMs$sn1)
res1_Phg_ug_m2_hxx<-res_media1B*Phgs$sn1 #/0.6 #$sn


par(mfrow=c(2,3))
plot(res1B_Phg_ug_m2_h)
plot(res1C_Phg_ug_m2_h)
plot(res1D_Phg_ug_m2_h)
plot(res1E_Phg_ug_m2_h)
plot(res1_Phg_ug_m2_hxx)
