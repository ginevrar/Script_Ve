...
datiM2008<-subset(datiM,ANNO==2008)
str(datiM2008)
summary(datiM2008)


X <- split.data.frame(datiM2008, datiM2008$Staz)
...
png('SPM_BOUNDARIES_2008.png', width = 21, height = 10,
    res=300,units = 'cm')
...
png('DatiMElaSPM_2008.png',width=29, height = 21, units='cm',res=200) 
par(mfrow=c(6,3), mar=c(2.6,2,1,1),oma=c(0,0,4.3,0), cex.axis=1.2)

plot(B01$B01.MESE,B01$B01.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B01, nodo 3765',3)
#text(B01$B01.MESE,B01$B01.TSS,labels=B01$B01.TSS)
mtext("Solidi in sospensione nelle acque (mg/l)", 3, outer = TRUE, line=1.8, cex=2,
      font=2)
plot(B02$B02.MESE,B02$B02.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B02, nodo 4036',3)

plot(B03$B03.MESE,B03$B03.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B03, nodo 4007',3)

plot(B04$B04.MESE,B04$B04.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B04, nodo 3549',3)

plot(B06$B06.MESE,B06$B06.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B06, nodo 3054',3)

plot(B07$B07.MESE,B07$B07.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B07, nodo 2904',3)

plot(B08$B08.MESE,B08$B08.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B08, nodo 2193',3)

plot(B09$B09.MESE,B09$B09.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B09, nodo 2409',3)

plot(B10$B10.MESE,B10$B10.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B10, nodo 2095',3)

plot(B11$B11.MESE,B11$B11.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B11, nodo 2419',3)

plot(B14$B14.MESE,B14$B14.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B14, nodo 1337',3)

plot(B16$B16.MESE,B16$B16.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B16, nodo 605',3)

plot(B17$B17.MESE,B17$B17.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B17, nodo 535',3)

plot(B19$B19.MESE,B19$B19.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B19, nodo 432',3)

plot(B20$B20.MESE,B20$B20.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B20, nodo 25',3)

plot(B31$B31.MESE,B31$B31.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. B31, nodo 2650',3)

plot(CI$CI.MESE,CI$CI.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. CI, nodo 2650',3)

plot(CS$CS.MESE,CS$CS.TSS, type='b',ylim=c(0,140),     col='darkorange', pch=24)
mtext('St. CS, nodo 2650',3)
dev.off()


png('DatiMElaPoM_2008.png',width=29, height = 21, units='cm',res=200) 
par(mfrow=c(6,3), mar=c(2.6,2,1,1),oma=c(0,0,4.3,0), cex.axis=1.2)
