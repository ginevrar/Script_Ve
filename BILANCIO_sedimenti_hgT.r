...
win.graph()
par(mfrow=c(1,3))
plot(tot_depo_hgPOM, col='cyan', type='l',ylim=c(0,2000))   #kg y
par(new=T)
plot(tot_depo_hgsilt, col='darkgoldenrod', type='l',lty=2,ylim=c(0,2000))
...
par(mfrow=c(1,1))
plot(TOTD,col='blue', type='l', ylim=c(-300,4000))
par(new=T)
plot(TOTR, col='red',type='l',ylim=c(-300,4000))
par(new=T)
plot(nnet, col=1,type='l',ylim=c(-300,4000))
...
#net depo* soilds 10-2   m/y * g/m3 ->10-2g/m2y  ## Depo_sed_g_m2y<- (NET_DEPO_cmy_df*Solidi_df)/10^2
