...
png('DEPO_kgm2y_fin83.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('DEPO_vs_Sarretta_fin83.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('DEPO_vs_Sarretta_fin83.png',
...
png('Burial_fin83.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('POC_perc_fin83.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
=======
  ...
  png('solids_sed_conc_fin83.png',width = 21, height = 29,
      units = "cm", res=400)
