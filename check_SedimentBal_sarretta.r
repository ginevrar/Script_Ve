...
png('DEPO_kgm2y_fin90c.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('DEPO_vs_Sarretta_fin90c.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('DEPO_vs_Sarretta_fin90c.png',
...
png('Burial_fin90c.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('POC_perc_fin90c.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
=======
  ...
  png('solids_sed_conc_fin90c.png',width = 21, height = 29,
      units = "cm", res=400)
