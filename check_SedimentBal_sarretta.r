...
b6_depo_2014 <-b6_depo_2014_gm2d*365/1000   #kg DW m2y
  ...
  par(mfrow=c(2,5))
  plot(rdate[3:203],netdepo_sed1[3:203], type='l',ylim=c(-1.6,1.6), col='#00000000', lwd=2)
   polygon(H_resus,yy1, col='#68676733',border = NA)
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b2,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2), lwd=2,border = '#313695',col='#31369599')
  par(new=T)
  plot(rdate[3:203],netdepo_sed1[3:203], type='l',ylim=c(-1.6,1.6), col=1, lwd=2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed2[3:203], ylim=c(-1.6,1.6),type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed4[3:203],ylim=c(-1.6,1.6),  type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed3[3:203],ylim=c(-1.6,1.6), type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed5[3:203], ylim=c(-1.6,1.6), type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b6,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2), border = '#fed976',col='#fed97699')
  par(new=T)
  plot(rdate[3:203],netdepo_sed6[3:203], type='l', ylim=c(-1.6,1.6), col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed7[3:203], ylim=c(-1.6,1.6),type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed8[3:203],ylim=c(-1.6,1.6), type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed9[3:203], ylim=c(-1.6,1.6),type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  par(new=T)
  plot(rdate[3:203],netdepo_sed10[3:203],ylim=c(-1.6,1.6), type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
