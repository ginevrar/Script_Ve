...
png('POM_fraction__oksba16b.png')
...
png('DEPO_kgm2y_fin92b__oksba16b.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
plot(depo1_kg_y/a1, type='l')     # 1989 - 1990: 114 g m 2 day-1 (st.A) - 2609 g m 2 day 1 (st.D)
...
summary(BURIAL_cmy)
  ...
  png('POC_perc_fin92b__oksba16b.png',width = 950, height = 530, units = "px")
  par(mfrow=c(2,5))
  ...
  png('DEPO_vs_Sarretta_fin92b__oksba16b.png',width = 950, height = 530, units = "px")
  par(mfrow=c(2,5))
...
=======
  ...
  png('DEPO_NET_fin92b__oksba16b.png',
  ...
  png('solids_sed_PERC_ba16b.png',width = 21, height = 29,
      units = "cm", res=400)
