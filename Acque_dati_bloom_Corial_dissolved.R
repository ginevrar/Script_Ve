...
sud_hgd<-data.frame(hgd$ws8[1214:1321],hgd$ws9[1214:1321], hgd$ws10[1214:1321])
...
nord_mhgd<-data.frame(mhgd$wn1[1214:1321],mhgd$wn2[1214:1321],mhgd$wn4[1214:1321]); names(nord_mhgd)<-c('w1','w2','w4')
centr_mhgd<-data.frame(mhgd$wc6[1214:1321], mhgd$wn3[1214:1321], mhgd$wn5[1214:1321],mhgd$wc7[1214:1321])
sud_mhgd<-data.frame(mhgd$ws8[1214:1321],mhgd$ws9[1214:1321], mhgd$ws10[1214:1321])
...
plot(rdate[1214:1321], mod_nord_mean,  ylim=c(0,100),xlab='',ylab='',type='l',col='royalblue',
         main='Northern Water', xlim=as.Date(c("2001-01-01", "2011-01-04"), "%Y-%m-%d"))
polygon(xx,NN, col='#4575b455',border = NA)
par(new=T)
plot(rdate[1225],nord_bloom_med_hgt,ylim=c(0,100),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n')
par(new=T)
...
p2<-plot(rdate[1214:1321], mod_cent_mean,  ylim=c(0,100),xlab='',ylab='',type='l',col='#d1740c99',yaxt='n',
         xlim=as.Date(c("2001-01-01", "2011-01-04"), "%Y-%m-%d"),
         main='Central Water')
...
plot(rdate[1225],central_bloom_med_hgt,ylim=c(0,100),pch=19,xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab='')
par(new=T)
...
plot(rdate[1227],centralIND_bloom_med_hgt,ylim=c(0,100),pch=19,xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")), col='darkgrey',
     ylab='')
par(new=T)
...
plot(rdate[1214:1321], mod_nord_mean_D,  ylim=c(0,15),xlab='',ylab='',type='l',col='royalblue',
         xlim=as.Date(c("2001-01-01", "2011-01-04"), "%Y-%m-%d"))
polygon(xx,NN_D, col='#4575b455',border = NA)
par(new=T)
plot(rdate[1225],nord_bloom_med_hgd,ylim=c(0,15),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab='')
mtext(side=2, expression(paste('ng l'^-1)), line=2.6, cex=0.85)
par(new=T)
plot(rdate[1225],nord_bloom_min_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')   
par(new=T)
plot(rdate[1225],nord_bloom_max_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
...
plot(rdate[1214:1321], mod_cent_mean_D,  ylim=c(0,15),xlab='',ylab='',type='l',col='#d1740c99',yaxt='n',
         xlim=as.Date(c("2001-01-01", "2011-01-04"), "%Y-%m-%d"))
polygon(xx,CC_D, col='#fed97666',border = NA)
par(new=T)
plot(rdate[1225],central_bloom_med_hgd,ylim=c(0,15),pch=19,xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab= '')
par(new=T)
plot(rdate[1225],central_bloom_min_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab='')   
par(new=T)
plot(rdate[1225],central_bloom_max_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab='')        
segments(rdate[1225],central_bloom_max_hgd,rdate[1225],central_bloom_min_hgd)
par(new=T)
plot(rdate[1227],centralIND_bloom_med_hgd,ylim=c(0,15),pch=19,xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")), col='darkgrey',
     ylab='')
par(new=T)
plot(rdate[1227],centralIND_bloom_min_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),col='darkgrey',
     ylab='')   
par(new=T)
plot(rdate[1227],centralIND_bloom_max_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),col='darkgrey',
     ylab='')   
segments(rdate[1227],centralIND_bloom_max_hgd,rdate[1227],centralIND_bloom_min_hgd,col='darkgrey')
par(new=T)
plot(tmp,corila$HgII,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',
...
p9<-plot(rdate[1214:1321], mod_sud_mean_D,  ylim=c(0,15),xlab='',ylab='',type='l',col='#82012099',yaxt='n',
         xlim=as.Date(c("2001-01-01", "2011-01-04"), "%Y-%m-%d"))
polygon(xx,SS_D, col='#82012066',border = NA)
par(new=T)
plot(rdate[1225],south_bloom_med_hgd,ylim=c(0,15),pch=19,xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab='')
par(new=T)
plot(rdate[1225],south_bloom_min_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab='')
par(new=T)
plot(rdate[1225],south_bloom_max_hgd,ylim=c(0,15),pch='-',xaxt='n',type='p',cex=2,xlab='',yaxt='n',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),
     ylab='')   
...
p10<-plot(rdate[1214:1321], mod_nord_mean_mhgd_D,  ylim=c(0,0.3),xlab='',ylab='',type='l', col='royalblue',
          xlim=as.Date(c("2001-01-01", "2011-01-04"), "%Y-%m-%d"))
polygon(xx,NN_mhg_D, col='#4575b455',border = NA)
par(new=T)
plot(rdate[1225],nord_bloom_med_mhgd, ylim=c(0,0.3),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')
mtext(side=2, expression(paste('ng l'^-1)), line=2.6, cex=0.85)
par(new=T)
plot(rdate[1225],nord_bloom_min_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')   
par(new=T)
plot(rdate[1225],nord_bloom_max_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')        
...
plot(rdate[1214:1321], mod_cent_mean_mhgd_D,  ylim=c(0,0.3),xlab='',ylab='',type='l',col='#d1740c99',yaxt='n',
          xlim=as.Date(c("2001-01-01", "2011-01-04"), yaxt='n',"%Y-%m-%d"))
polygon(xx,CC_mhg_D, col='#fed97666',border = NA)
par(new=T)
plot(rdate[1225],central_bloom_med_mhgd, ylim=c(0,0.3),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')
par(new=T)
plot(rdate[1225],central_bloom_min_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')   
par(new=T)
plot(rdate[1225],central_bloom_max_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')        
segments(rdate[1225],central_bloom_max_mhgd,rdate[1225],central_bloom_min_mhgd)
par(new=T)
plot(rdate[1227],centralIND_bloom_med_mhgd, ylim=c(0,0.3),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")), col='darkgrey',yaxt='n',
     ylab='')
par(new=T)
plot(rdate[1227],centralIND_bloom_min_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),col='darkgrey',yaxt='n',
     ylab='')   
par(new=T)
plot(rdate[1227],centralIND_bloom_max_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),col='darkgrey',yaxt='n',
     ylab='')   
...
segments(tmp[6],corila$MeHg[6],tmp[6],corila$MeHg[12],col='#000B4D')
 ...
 plot(rdate[1214:1321], mod_sud_mean_mhgd_D,  ylim=c(0,0.3),xlab='',ylab='',type='l',col='#820120',yaxt='n',
          xlim=as.Date(c("2001-01-01", "2011-01-04"), "%Y-%m-%d"))
polygon(xx,SS_mhg_D, col='#82012066',border = NA)
par(new=T)
plot(rdate[1225],south_bloom_med_mhgd, ylim=c(0,0.3),pch=19,xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')
par(new=T)
plot(rdate[1225],south_bloom_min_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')   
par(new=T)
plot(rdate[1225],south_bloom_max_mhgd, ylim=c(0,0.3),pch='-',xaxt='n',type='p',cex=2,xlab='',
     xlim=as.Date(c("2001-01-01", "2011-01-04")),yaxt='n',
     ylab='')   
