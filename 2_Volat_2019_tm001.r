...
names(hg0)<-c('time','wn1','wn2','wn3','wn4','wn5','wc6','wc7','ws8','ws9','ws10',
 ...
 hg0_19<-hg0[1251764:1262275,1:11]
...
hgII_19<-hgII[1251764:1262275,1:11]
hgII<-NA

str(hg0_95)

       #1995
rdate19<-rdate[1251764:1262275]   #2019
...
evasion_19<-evasion[1251764:1262275,1:11]
...
phRed_19<-phRed[1251764:1262275,1:11]
phRed<-NA

mehg<-read.csv("Divalent_Hg.csv", header=FALSE, skip = 1, sep = ",", dec=".")
names(mehg)<-c('time','wn1','wn2','wn3','wn4','wn5','wc6','wc7','ws8','ws9','ws10',
               'sn1','sn2','sn3','sn4','sn5','sc6','sc7','ss8','ss9','ss10',
               'dsn1','dsn2','dsn3','dsn4','dsn5','dsc6','dsc7','dss8','dss9','dss10',
               'osn1','osn2','osn3','osn4','osn5','osc6','osc7','oss8','oss9','oss10')
mehg_19<-mehg[1251764:1262275,1:11]
mehg<-NA
