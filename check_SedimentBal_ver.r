...
DF<-Diffusion_coeff*60*60*24       #m2/day
 ...
 burial_sed1 <-burial$dsn1/100  #cm/y
 burial_sed2 <-burial$dsn2/100   #cm/y
 burial_sed3 <-burial$dsn3/100   #cm/y  burial_sed4 <-burial$dsn4  #cm/y   burial_sed5 <-burial$dsn5  #cm/y
 burial_sed4 <-burial$dsn4/100   #cm/y  burial_sed4 <-burial$dsn4  #cm/y   burial_sed5 <-burial$dsn5  #cm/y
 burial_sed5 <-burial$dsn5/100   #cm/y  burial_sed4 <-burial$dsn4  #cm/y   burial_sed5 <-burial$dsn5  #cm/y
 burial_sed6 <-burial$dsc6/100   #cm/y
 burial_sed7 <-burial$dsc7/100  #cm/y
 burial_sed8 <-burial$dss8/100   #cm/y
 burial_sed9 <-burial$dss9/100   #cm/y
 burial_sed10 <-burial$dss10/100   #cm/y
...
png('NET_DEPO_ty.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
plot(netdepo_sed1/10^6, type='l', col='#313695', lwd=2)
plot(netdepo_sed2/10^6, type='l', col='#4575b4', lwd=2)
plot(netdepo_sed4/10^6, type='l', col='#abd9e9', lwd=2)
plot(netdepo_sed3/10^6,type='l', col='#DDF26B', lwd=2)
plot(netdepo_sed5/10^6,  type='l', col='#e5e572', lwd=2)
plot(netdepo_sed6/10^6, type='l',  col='#fed976', lwd=2)
plot(netdepo_sed7/10^6,  type='l', col='#f79220', lwd=2)
plot(netdepo_sed8/10^6,  type='l', col='#f46d43', lwd=2)
plot(netdepo_sed9/10^6, type='l', col='#d73027', lwd=2)
plot(netdepo_sed10/10^6, type='l', col='#a50028', lwd=2)
dev.off()
