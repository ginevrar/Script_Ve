...
hgpom_res1 <- POM_res1_m_day*POMs$sn1*(fhgPOM*SEDhg$sn1)
hgpom_res2 <- POM_res2_m_day*POMs$sn2*(fhgPOM*SEDhg$sn2)
hgpom_res3 <- POM_res3_m_day*POMs$sn3*(fhgPOM*SEDhg$sn3) 
hgpom_res4 <- POM_res4_m_day*POMs$sn4*(fhgPOM*SEDhg$sn4)
hgpom_res5 <- POM_res5_m_day*POMs$sn5*(fhgPOM*SEDhg$sn5)
hgpom_res6 <- POM_res6_m_day*POMs$sc6*(fhgPOM*SEDhg$sc6)
hgpom_res7 <- POM_res7_m_day*POMs$sc7*(fhgPOM*SEDhg$sc7)
hgpom_res8 <- POM_res8_m_day*POMs$ss8*(fhgPOM*SEDhg$ss8)
hgpom_res9 <- POM_res9_m_day*POMs$ss9*(fhgPOM *SEDhg$ss9)
hgpom_res10<- POM_res10_m_day*POMs$ss10*(fhgPOM*SEDhg$ss10) 

hgsilt_res1<- silt_res1_m_day*silts$sn1*fhgsilt*SEDhg$sn1
hgsilt_res2<- silt_res2_m_day*silts$sn2*fhgsilt*SEDhg$sn2 
hgsilt_res3<- silt_res3_m_day*silts$sn3*fhgsilt*SEDhg$sn3
hgsilt_res4<- silt_res4_m_day*silts$sn4*fhgsilt*SEDhg$sn4 
hgsilt_res5<- silt_res5_m_day*silts$sn5*fhgsilt*SEDhg$sn5
hgsilt_res6<- silt_res6_m_day*silts$sc6*fhgsilt*SEDhg$sc6 
hgsilt_res7<- silt_res7_m_day*silts$sc7*fhgsilt*SEDhg$sc7
hgsilt_res8<- silt_res8_m_day*silts$ss8*fhgsilt*SEDhg$ss8 
hgsilt_res9<- silt_res9_m_day*silts$ss9*fhgsilt*SEDhg$ss9
hgsilt_res10<- silt_res10_m_day*silts$ss10*fhgsilt*SEDhg$ss10 

#depo ug/m2d  - res ng/m2d/1000 = ug dm2
hgbal_1 <-(hgpom_dep1+hgsilt_dep1) - ((hgpom_res1+hgsilt_res1)/1000)      #ng/m2d
hgbal_2 <-(hgpom_dep2+hgsilt_dep2) - ((hgpom_res2+hgsilt_res2)/1000) 
hgbal_3 <-(hgpom_dep3+hgsilt_dep3) - ((hgpom_res3+hgsilt_res3)/1000)
hgbal_4 <-(hgpom_dep4+hgsilt_dep4) - ((hgpom_res4+hgsilt_res4)/1000) 
hgbal_5 <-(hgpom_dep5+hgsilt_dep5) - ((hgpom_res5+hgsilt_res5)/1000) 
hgbal_6 <-(hgpom_dep6+hgsilt_dep6) - ((hgpom_res6+hgsilt_res6)/1000) 
hgbal_7 <-(hgpom_dep7+hgsilt_dep7) - ((hgpom_res7+hgsilt_res7)/1000) 
hgbal_8 <-(hgpom_dep8+hgsilt_dep8) - ((hgpom_res8+hgsilt_res8)/1000) 
hgbal_9 <-(hgpom_dep9+hgsilt_dep9) - ((hgpom_res9+hgsilt_res9)/1000)
hgbal_10<-(hgpom_dep10+hgsilt_dep10) - ((hgpom_res10+hgsilt_res10)/1000) 

plot(hgbal_6)

hgbal<- hgbal_1+hgbal_2+hgbal_3+hgbal_4+hgbal_5+hgbal_6+hgbal_7+hgbal_8+hgbal_9+hgbal_10

Tot_Depo_hg_ugm2d<-hgsilt_dep1+ hgpom_dep1+hgsilt_dep2+ hgpom_dep2+hgsilt_dep3+ hgpom_dep3+hgsilt_dep4+ hgpom_dep4+
...
Tot_res_hg_ugm2d<-(hgsilt_res1+ hgpom_res1+hgsilt_res2+ hgpom_res2+hgsilt_res3+ hgpom_res3+hgsilt_res4+ hgpom_res4+
hgsilt_res5+ hgpom_res5+hgsilt_res6+ hgpom_res6+hgsilt_res7+ hgpom_res7+hgsilt_res8+ hgpom_res8+
hgsilt_res9+ hgpom_res9+hgsilt_res10+ hgpom_res10)/1000

Tot_Depo_hg_kgy<-Tot_Depo_hg_ugm2d*area*365/10^9 #kg/y
Tot_res_hg_kgy<-Tot_res_hg_ugm2d*area*365/10^9

Net_ugm2d<-(Tot_Depo_hg_ugm2d-Tot_res_hg_ugm2d)

Net_ugm2d_media<-tapply(Net_ugm2d[1:2412], 
                            rep(1:(length(Net_ugm2d[1:2412])/12),each = 12),mean)

#head(rdate[1:2412])
Net_kgy1<-as.numeric(Net_ugm2d_media)*area*365/10^9
