...
setwd('C:/Users/Ginevra/Dropbox/fin5/fin5f')
...
epsilon <- .7
#dev.new()
png('profile_ZONTA_datoModeo3_fin5f.png',width = 1000*1.5, height = 530*1.5,  
    units = "px")
...
par(new=T)
plot(b1_profile_mean,y,xlim=c(0,2), ylim=c(-40,0), col='#313695',xaxt='n',yaxt='n',
     cex=1.6,type='b', pch=21)
par(new=T)
plot(b1_profile_mod/1000,y,xlim=c(0,2), cex=1.6, ylim=c(-40,0), yaxt='n',
...
plot(b2_profile,y,xlim=c(0,2), ylim=c(-40,0),  cex=1.6,yaxt='n',
...
par(new=T)
plot(b2_profile_mean,y,xlim=c(0,2), ylim=c(-40,0),  cex=1.6,yaxt='n',
     col='#4575b4', type='b', pch=21)
par(new=T)
plot(b2_profile_mod/1000,y,xlim=c(0,2), ylim=c(-40,0),yaxt='n',
...
plot(b4_profile,y,xlim=c(0,2),  ylim=c(-40,0), cex=1.6,yaxt='n',
...
par(new=T)
plot(b4_profile_mean,y,xlim=c(0,2),  ylim=c(-40,0), cex=1.6,yaxt='n',
     col='#abd9e9',type='b', pch=21)
par(new=T)
plot(b4_profile_mod/1000,y,xlim=c(0,2),  cex=1.6,ylim=c(-40,0),yaxt='n', col='#abd9e9',bg='#abd9e977', type='b', pch=25)
#mtext(side=1, text=expression(paste ('??g g'^-1)), cex=1.6, line=1.9)
mtext(side=3, text='box 4', font=2, cex=1.4, line=.5)

plot(b3_profile,y,xlim=c(0,2), ylim=c(-40,0), cex=1.6,yaxt='n',
...
par(new=T)
plot(b3_profile_mean,y,xlim=c(0,2), ylim=c(-40,0), cex=1.6,yaxt='n',
     col='#DDF26B',type='b', pch=21)
par(new=T)
plot(b3_profile_mod/1000,y,xlim=c(0,2), yaxt='n', cex=1.6,ylim=c(-40,0), 
     col='#DDF26B', bg='#DDF26B77', type='b', pch=25)
#mtext(side=1, text=expression(paste ('??g g'^-1)), cex=1.6, line=1.9)
mtext(side=3, text='box 3', font=2, cex=1.4, line=.5)

plot(b5_profile,y,xlim=c(0,4), ylim=c(-40,0), yaxt='n',col='#e5e572', cex=1.6, bg='#e5e57277',  type='b', pch=21)
...
par(new=T)
plot(b5_profile_mean,y,xlim=c(0,4), ylim=c(-40,0),yaxt='n', col='#e5e572', cex=1.6,  type='b', pch=21)
par(new=T)
plot(b5_profile_mod/1000,y,xlim=c(0,4), ylim=c(-40,0),yaxt='n', cex=1.6, col='#e5e572', bg='#e5e57277',type='b', pch=25)
#mtext(side=1, text=expression(paste ('??g g'^-1)), cex=1.6, line=1.9)
...
par(new=T)
plot(b6_profile_mean,y,xlim=c(0,4),  cex=1.6, yaxt='n',ylim=c(-40,0),col='#fed976',type='b', pch=21)
par(new=T)
plot(b6_profile_mod/1000,y,xlim=c(0,4),yaxt='n',  cex=1.6,ylim=c(-40,0), col='#fed976', bg='#fed97677',  type='b', pch=25)
mtext(side=2, text='depth (cm)',  cex=1.6, line=3)
mtext(side=1, text=expression(paste ('??g g'^-1)), cex=1.6, line=1.9)
mtext(side=3, text='box 6', font=2, cex=1.4, line=.5)

plot(b7_profile,y,xlim=c(0,2),  ylim=c(-40,0), cex=1.6,yaxt='n', 
...
par(new=T)
plot(b7_profile_mean,y,xlim=c(0,2),yaxt='n',xaxt='n', ylim=c(-40,0), cex=1.6,
     col='#f79220',  type='b', pch=21)
par(new=T)
plot(b7_profile_mod/1000,y,xlim=c(0,2), yaxt='n',xaxt='n', cex=1.6,ylim=c(-40,0), 
     col='#f79220',bg='#f7922077',  type='b', pch=25)
mtext(side=1, text=expression(paste ('??g g'^-1)), cex=1.6, line=1.9)
mtext(side=3, text='box 7', font=2, cex=1.4, line=.5)

plot(b8_profile,y,xlim=c(0,2), ylim=c(-40,0), cex=1.6,yaxt='n',
...
par(new=T)
plot(b8_profile_mean,y,xlim=c(0,2), ylim=c(-40,0), cex=1.6,yaxt='n',
     col='#f46d43',  type='b', pch=21)
par(new=T)
plot(b8_profile_mod/1000,y,xlim=c(0,2), ylim=c(-40,0), cex=1.6,yaxt='n',
     col='#f46d43',bg='#f46d4377',  type='b', pch=25)
mtext(side=1, text=expression(paste ('??g g'^-1)), cex=1.6, line=1.9)
mtext(side=3, text='box 8', font=2, cex=1.4, line=.5)

plot(b9_profile,y,xlim=c(0,2), ylim=c(-40,0),  cex=1.6,yaxt='n',
...
par(new=T)
plot(b9_profile_mean,y,xlim=c(0,2), ylim=c(-40,0),  cex=1.6,yaxt='n',
     col='#d73027',  type='b', pch=21)
par(new=T)
plot(b9_profile_mod/1000,y,xlim=c(0,2), ylim=c(-40,0), cex=1.6,yaxt='n',
     col='#d73027',bg='#d7302777', type='b', pch=25)
mtext(side=1, text=expression(paste ('??g g'^-1)), cex=1.6, line=1.9)
mtext(side=3, text='box 9', font=2, cex=1.4, line=.5)

plot(b10_profile,y,xlim=c(0,2), ylim=c(-40,0), col='#a50028', yaxt='n', cex=1.6,
...
par(new=T)
plot(b10_profile_mean,y,xlim=c(0,2), ylim=c(-40,0), col='#a50028', yaxt='n', cex=1.6,
     type='b', pch=21)
par(new=T)
plot(b10_profile_mod/1000,y,xlim=c(0,2), ylim=c(-40,0), cex=1.6,yaxt='n',
