...
outf_10<-mean(hg_outflow_kg_y_media[11]+hg_disper_kg_y_media[11])
 
ev_95<-mean(evasione_kg_y_media[100])
dp_95<-mean(depo_Phg_kg_y_media[100])
outf_95<-mean(hg_outflow_kg_y_media[100]+hg_disper_kg_y_media[100])

ev_70<-mean(evasione_kg_y_media[71])
dp_70<-mean(depo_Phg_kg_y_media[71])
outf_70<-mean(hg_outflow_kg_y_media[71]+hg_disper_kg_y_media[71])

# output 2019 
ev_19<-mean(evasione_kg_y_media[120])
dp_19<-mean(depo_Phg_kg_y_media[120])
outf_19<-mean(hg_outflow_kg_y_media[120]+hg_disper_kg_y_media[120])
...
sum(All_in_70) ;outf_70-depo70-ev_10
sum(bilancio_hg_70)
