...
box1_MAV<-c(0.8,0.6,0.9)*1000
box2_MAV<-c(0.8,0.8,0.8,0.7,0.3,0.4,1,0.7)*1000
box3_MAV<-c(1.1,0.2,1.4,0.4,0.2)*1000
box4_MAV<-c(1,0.6,0.8)*1000
box5_MAV<-c(0.8,0.2,0.7,1.2,0.6,1,0.7,0.3,0.6)*1000
box6_MAV<-c(0.8,0.9,1.5,0.9,0.9,1.4,1.6,1.3,0.9,1.9,0.7,0.2,1.3)*1000
box7_MAV<-c(1.5,0.9,0.2,1.2,0.7,0.5,0.3,0.7,0.2,0.1,0.1,0.3,0.4,0.5,0.4,0.1,0.6,0.8,0.7)*1000
box8_MAV<-c(0.8,0.3,0.3,0.5)*1000
box9_MAV<-c(0.5,0.1,0.1,0.4)*1000
box10_MAV<-c(0.7,0.1,0.1)*1000
...
a20<-data.frame(hg$dsn1,hg$sn1,hg$osn1);b20<-data.frame(hg$dsn2,hg$sn2,hg$osn2)
c20<-data.frame(hg$dsn3,hg$sn3,hg$osn3);d20<-data.frame(hg$dsn4,hg$sn4,hg$osn4)
e20<-data.frame(hg$dsn5,hg$sn5,hg$osn5);f20<-data.frame(hg$dsc6,hg$sc6,hg$osc6)
g20<-data.frame(hg$dsc7,hg$sc7,hg$osc7);h20<-data.frame(hg$dss8,hg$ss8,hg$oss8)
i20<-data.frame(hg$dss9,hg$ss9,hg$oss9);l20<-data.frame(hg$dss10,hg$ss10,hg$oss10)

media1_20<-rowMeans(a20);media2_20<-rowMeans(b20);media3_20<-rowMeans(c20);
media4_20<-rowMeans(d20);media5_20<-rowMeans(e20);
media6_20<-rowMeans(f20); media7_20<-rowMeans(g20); 
media8_20<-rowMeans(h20); media9_20<-rowMeans(i20); media10_20<-rowMeans(l20)
...
plot(rdate[2: 2427],media2[2: 2427],ylim=c(-50,5000), type='l', col='#4575b4',lwd=2,
...
par(new=T)
plot(rdate[2: 2427],media2_20[2: 2427],ylim=c(-50,5000), type='l', col='#4575b4',
     lty=1,lwd=2,main=' ',ylab= '',yaxt='n',
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
boxplot(box2_77,box2_MAV, Zonta2,ylim=c(-50,5000),
        col='#4575b488',xlim=c(rdate[2],rdate[2427]),
        at=c(c1,c2,c5),
        boxwex=1700,xaxt='n',ylab= '',yaxt='n')


plot(rdate[2: 2427],media4[2: 2427], ylim=c(-50,5000), type='l',col='#abd9e9',lwd=2,main='Box4',
     xlab= '',ylab= '',yaxt='n', cex.lab=2 , cex.main=1.7 ,lty=3, cex.axis=1.6)
 x=c(c1-1000,c2-441,c5+500+950)
y=c(1500,-40,1500)
text(x, y, v_text,cex=1.2)  # 10 c0 c
par(new=T)
plot(rdate[2: 2427],media4_20[2: 2427], ylim=c(-50,5000),lty=1, type='l',col='#abd9e9',lwd=2,main=' ',
     xlab= '',ylab= '', cex.lab=2 ,yaxt='n', cex.main=1.7 , cex.axis=1.6)
par(new=T)
boxplot(box4_77, box4_MAV, Zonta4, ylim=c(-50,5000),
        col='#abd9e988',xlim=c(rdate[2],rdate[2427]),at=c(c1,c2,c5),
        range=F,
        boxwex=1700,xaxt='n',ylab= '',yaxt='n')
 

plot(rdate[2: 2427],media3[2: 2427], ylim=c(-50,5000), type='l',col='#DDF26B',
...
text(x, y, v_text,cex=1.2)  # 10 c
par(new=T)
plot(rdate[2: 2427],media3_20[2: 2427], ylim=c(-50,5000), type='l',col='#DDF26B',
     lty=1,lwd=2,main=' ',
     xlab= '',ylab= '', cex.lab=2 , cex.main=1.7 ,yaxt='n', cex.axis=1.6)
par(new=T)
boxplot(box3_77,box3_MAV,Zonta3,ylim=c(-50,5000),col='#DDF26B88',
        xlim=c(rdate[2],rdate[2427]),at=c(c1,c2,c5),
        ylab= '',boxwex=1700,xaxt='n',yaxt='n' , range=F)#

plot(rdate[2: 2427],media5[2: 2427], ylim=c(-50,5000), type='l',col='#e5e572',lwd=2, main='Box5',
     xlab= '',ylab= '', cex.lab=2 , cex.main=1.7 , lty=3,yaxt='n', cex.axis=1.6)
 x=c(c1-1000,c2-441,c5+500+950)
y=c(3000,-40,3000)
text(x, y, v_text,cex=1.2)  # 10 
par(new=T)
plot(rdate[2: 2427],media5_20[2: 2427], ylim=c(-50,5000), type='l',col='#e5e572',
     lty=1,lwd=2, main='Box5',
     xlab= '',ylab= '', cex.lab=2 , cex.main=1.7 ,yaxt='n', 
     cex.axis=1.6)
par(new=T)
boxplot(box5_77,box5_MAV,Zonta5, ylim=c(-50,5000),col='#e5e57288',ylab= '',varwidth = F,
...
#par(mar=c(3,5,2,0))   
plot(rdate[2: 2427],media6[2: 2427], ylim=c(-50,5000),
...
text(x, y, v_text,cex=1.2)  # 10 c
par(new=T)
plot(rdate[2: 2427],media6_20[2: 2427], ylim=c(-50,5000), type='l',
     col='#fed976',lty=1,yaxt='n',lwd=2, main='Box6',
     ylab='Hg (ng/g)',xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)#
par(new=T)
boxplot(box6_77,box6_MAV,Zonta6, ylim=c(-50,5000),col='#fed97688', ylab=' ', 
          xlim=c(rdate[2],rdate[2427]),at=c(c1,c2,c5),range=F,
        boxwex=1700,xaxt='n',yaxt='n', outline=F)


#par(mar=c(3,2,2,3))
plot(rdate[2: 2427],media7[2: 2427], ylim=c(-50,5000),type='l',ylab= '',col='#f79220',
...
text(x, y, v_text,cex=1.2)  # 10 c
par(new=T)
plot(rdate[2: 2427],media7_20[2: 2427], ylim=c(-50,5000),type='l',ylab= '',
     col='#f79220',lty=1,lwd=2,  main=' ',
     xlab= '', cex.lab=2 , cex.main=1.7 ,yaxt='n', cex.axis=1.6)
par(new=T)
boxplot(box7_77,box7_MAV,Zonta7,ylim=c(-50,5000),col='#f7922088',
        xlim=c(rdate[2],rdate[2427]),at=c(c1,c2,c5),
        ylab= '',boxwex=1700,xaxt='n',yaxt='n' , range=F)#


plot(rdate[2: 2427],media8[2: 2427], ylim=c(-50,5000), type='l',ylab= '', 
...
text(x, y, v_text,cex=1.2) 
par(new=T)
plot(rdate[2: 2427],media8_20[2: 2427], ylim=c(-50,5000), type='l',ylab= '',yaxt='n',
     lty=1, col='#f46d43',lwd=2, main='Box8',
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
boxplot(box8_77, box8_MAV,Zonta8,ylim=c(-50,5000),col='#f46d4388',
        xlim=c(rdate[2],rdate[2427]),at=c(c1, c2,c5),
        boxwex=1700,xaxt='n',ylab= '', yaxt='n', range=F)

plot(rdate[2: 2427],media9[2: 2427], ylim=c(-50,5000), type='l',
...
text(x, y, v_text,cex=1.2) 
par(new=T)
plot(rdate[2: 2427],media9_20[2: 2427], ylim=c(-50,5000), type='l',col='#d73027',ylab= '',
     lty=1,lwd=2, main='Box9',yaxt='n',
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
boxplot(box9_77, box9_MAV,Zonta9, ylim=c(-50,5000),col='#d7302788',
        xlim=c(rdate[2],rdate[2427]),at=c(c1, c2,c5),
        boxwex=1700,ylab= '',xaxt='n',yaxt='n', range=F)


plot(rdate[2: 2427],media10[2: 2427], ylim=c(-50,5000), 
     type='l',col='#a50028',
...
par(new=T)
plot(rdate[2: 2427],media10_20[2: 2427], ylim=c(-50,5000),
     type='l',yaxt='n',xaxt='n',
     col='#a50028',lty=1,ylab= '',lwd=2, main='Box10',
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
boxplot(box10_77,box10_MAV,Zonta10, ylim=c(-50,5000),xlim=c(rdate[2],rdate[2427]),
