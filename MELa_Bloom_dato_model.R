...
png('confr_MEla_E_Bloom___fin23_.png',width = 30, 
...
boxplot(sud_hg, Water_sud_bloom,Water_sud,  main='Hg acque sud', ylab='ng/L',
        ...
        col=c('#d73027','#d7302788','#d7302733'), cex.main=2, ylim=c(0,50))
dev.off()
...
png('Mela_time_63_fin23.png', width = 750, height = 800, units = "px")
