...
depo_Phg_kg_y_media<-tapply(netDepo1_kg_y[15:2426], 
                            rep(1:(length(netDepo1_kg_y[15:2426])/12),each = 12),mean)
...
bilancio_hg<-c(T_in,ri,ev,dp, outc,T_ou)
names(bilancio_hg)<-c('input','river','evas','depo','outflow','output')
bilancio_hg
...
plot(ax2, atm_hg, col="cyan3", type="l", ylim=c(-200,60), 
     main=expression(paste('Flussi di Hg'[T]*'alla laguna')), ylab= " ", 
     xlab= " ",  lwd=1, cex.axis=2, cex.lab=2,cex.main=2.3)
par(new=T)
plot(ax2,empty_v, type='p', xlab= " ", ylab= " ",
     pch=23, cex=2.8, xaxt='n',yaxt='n', ylim=c(-200,60), bg='cyan4',col='black')
...
plot(ax2,river_hg, col="chartreuse3", type="l", 
     xaxt='n',yaxt='n', ylim=c(-200,60), 
     ylab= " ",xlab= " ",  lwd=1)
par(new=TRUE)
plot(ax2,empty_v2, bg='chartreuse4' ,col='black',type='p',
     xlab= " ", ylab= " ", 
     pch=23, cex=2.8, xaxt='n',yaxt='n',ylim=c(-200,60))
#par(new=TRUE)
#plot(ax2,hg_inflow_kg_y_media, col="darkblue", type="l", 
 #    xaxt='n',yaxt='n',
  #   ylim=c(-60,60), ylab= " ", xlab= " ",  lwd=1.2)
#par(new=TRUE)
...
plot(ax2,Marghera, bg='grey90' ,col='gray50',type='l', xlab= " ", ylab= " ", 
     pch=23, cex=4, xaxt='n',yaxt='n',ylim=c(-200,60))
par(new=TRUE)
plot(ax2,-evasione_kg_y_media, col="cyan4", type="l", xlab= " ", 
   ylim=c(-200,60), xaxt='n',yaxt='n',
     main=" ", ylab= " ",  lwd=1)
par(new=TRUE)
plot(ax2,empty_v6, bg='cyan4' ,col='black',type='p',
     xlab= " ", ylab= " ", pch=23, cex=2.8, xaxt='n',
     yaxt='n', ylim=c(-200,60))
par(new=TRUE)
plot(ax2,-depo_Phg_kg_y_media, col="orange", type="l", 
     xlab= " ", 
     ylim=c(-200,60), xaxt='n',yaxt='n',
     ylab= " ",  lwd=1)
par(new=TRUE)
...
plot(ax2, -hg_outflow_kg_y_media, col="darkblue", type="l", 
     ...
     ylab= " ",  lwd=1)
par(new=TRUE)
plot(ax2,empty_v8, bg=' darkblue' ,col='black',type='p',
     xlab= " ", ylab= " ", 
     pch=23, cex=2.8, xaxt='n',yaxt='n', ylim=c(-1000,1000))
par(new=TRUE)
