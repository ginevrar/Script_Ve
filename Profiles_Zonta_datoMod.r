...
b1_max_mod<-c(max(hg$la1[1298:1309]), max(hg$lb1[1298:1309]),max(hg$lc1[1298:1309]),max(hg$ld1[1298:1309]),NA)
b1_min_mod<-c(min(hg$la1[1298:1309]), min(hg$lb1[1298:1309]),min(hg$lc1[1298:1309]),min(hg$ld1[1298:1309]), NA)

b2_profile_mod<-c(mean(hg$la2[1298:1309]), mean(hg$lb2[1298:1309]),mean(hg$lc2[1298:1309]), mean(hg$ld2[1298:1309]), NA)
b2_max_mod<-c(max(hg$la2[1298:1309]), max(hg$lb2[1298:1309]),max(hg$lc2[1298:1309]), max(hg$ld2[1298:1309]), NA)
b2_min_mod<-c(min(hg$la2[1298:1309]), min(hg$lb2[1298:1309]),min(hg$lc2[1298:1309]), min(hg$ld2[1298:1309]), NA)

b3_profile_mod<-c(mean(hg$la3[1298:1309]), mean(hg$lb3[1298:1309]),mean(hg$lc3[1298:1309]),mean(hg$ld3[1298:1309]), NA)
b3_max_mod<-c(max(hg$la3[1298:1309]), max(hg$lb3[1298:1309]),max(hg$lc3[1298:1309]),max(hg$ld3[1298:1309]), NA)
b3_min_mod<-c(min(hg$la3[1298:1309]), min(hg$lb3[1298:1309]),min(hg$lc3[1298:1309]),min(hg$ld3[1298:1309]), NA)

b4_profile_mod<-c(mean(hg$la4[1298:1309]), mean(hg$lb4[1298:1309]),mean(hg$lc4[1298:1309]),mean(hg$ld4[1298:1309]), NA)
b4_max_mod<-c(max(hg$la4[1298:1309]), max(hg$lb4[1298:1309]),max(hg$lc4[1298:1309]),max(hg$ld4[1298:1309]), NA)
b4_min_mod<-c(max(hg$la4[1298:1309]), min(hg$lb4[1298:1309]),min(hg$lc4[1298:1309]),min(hg$ld4[1298:1309]), NA)

b5_profile_mod<-c(mean(hg$la5[1298:1309]), mean(hg$lb5[1298:1309]),mean(hg$lc5[1298:1309]),mean(hg$ld5[1298:1309]), NA)
b5_max_mod<-c(max(hg$la5[1298:1309]), max(hg$lb5[1298:1309]),max(hg$lc5[1298:1309]),max(hg$ld5[1298:1309]), NA)
b5_min_mod<-c(min(hg$la5[1298:1309]), min(hg$lb5[1298:1309]),min(hg$lc5[1298:1309]),min(hg$ld5[1298:1309]), NA)

b6_profile_mod<-c(mean(hg$la6[1298:1309]), mean(hg$lb6[1298:1309]),mean(hg$lc6[1298:1309]),mean(hg$ld6[1298:1309]), NA)
b6_max_mod<-c(max(hg$la6[1298:1309]), max(hg$lb6[1298:1309]),max(hg$lc6[1298:1309]),max(hg$ld6[1298:1309]), NA)
b6_min_mod<-c(min(hg$la6[1298:1309]), min(hg$lb6[1298:1309]),min(hg$lc6[1298:1309]),min(hg$ld6[1298:1309]), NA)

b7_profile_mod<-c(mean(hg$la7[1298:1309]), mean(hg$lb7[1298:1309]),mean(hg$lc7[1298:1309]),mean(hg$ld7[1298:1309]), NA)
b7_max_mod<-c(max(hg$la7[1298:1309]), max(hg$lb7[1298:1309]),max(hg$lc7[1298:1309]),max(hg$ld7[1298:1309]), NA)
b7_min_mod <-c(min(hg$la7[1298:1309]), min(hg$lb7[1298:1309]),min(hg$lc7[1298:1309]),min(hg$ld7[1298:1309]), NA)

b8_profile_mod<-c(mean(hg$la8[1298:1309]), mean(hg$lb8[1298:1309]),mean(hg$lc8[1298:1309]),mean(hg$ld8[1298:1309]), NA)
b8_max_mod<-c(max(hg$la8[1298:1309]), max(hg$lb8[1298:1309]),max(hg$lc8[1298:1309]),max(hg$ld8[1298:1309]), NA)
b8_min_mod<-c(min(hg$la8[1298:1309]), min(hg$lb8[1298:1309]),min(hg$lc8[1298:1309]),min(hg$ld8[1298:1309]), NA)

b9_profile_mod<-c(mean(hg$la9[1298:1309]), mean(hg$lb9[1298:1309]),mean(hg$lc9[1298:1309]),mean(hg$ld9[1298:1309]), NA)
b9_max_mod<-c(max(hg$la9[1298:1309]), max(hg$lb9[1298:1309]),max(hg$lc9[1298:1309]),max(hg$ld9[1298:1309]), NA)
b9_min_mod<-c(min(hg$la9[1298:1309]), min(hg$lb9[1298:1309]),min(hg$lc9[1298:1309]),min(hg$ld9[1298:1309]), NA)

b10_profile_mod<-c(mean(hg$la10[1298:1309]), mean(hg$lb10[1298:1309]),mean(hg$lc10[1298:1309]),mean(hg$ld10[1298:1309]), NA)
b10_max_mod<-c(max(hg$la10[1298:1309]), max(hg$lb10[1298:1309]),max(hg$lc10[1298:1309]),max(hg$ld10[1298:1309]), NA)
b10_min_mod<-c(min(hg$la10[1298:1309]), min(hg$lb10[1298:1309]),min(hg$lc10[1298:1309]),min(hg$ld10[1298:1309]), NA)
...
#    units = "px")
par(mfrow=c(2,5),mar=c(0,1,1,1), oma=c(4,2.5,3,1),  bty='n',cex=1.5) # bg='black',fg = 'white',col.axis = "white", col.clab = "white"

plot(b1_profile,y,xlim=c(0,1.5), ylim=c(-40,0), col='#313695',xaxt='n',
     bg='#31369577',  type='b', pch=21)
...
par(new=T)
plot(b1_profile_mean,y,xlim=c(0,1.5), ylim=c(-40,0), col='#313695',xaxt='n',
      type='b', pch=21)
par(new=T)
plot(b1_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0), xaxt='n',yaxt='n',
     col='#313695',bg='#31369577',   type='b', pch=25)
mtext(side=2, text='depth (cm)', line=2)
mtext(side=1, text=expression(paste('??g g'^-1)), line=1.5)
mtext(side=3, text='box 1', font=2, line=-.5)

plot(b2_profile,y,xlim=c(0,1.5), ylim=c(-40,0), col='#4575b4',yaxt='n',
     bg='#4575b477', type='b',xaxt='n', pch=21)
...
segments(b2_profile+b2_SD,y-epsilon,b2_profile+b2_SD,y+epsilon, col='#4575b4', lwd=1.8)
par(new=T)
plot(b2_profile_mod/1000,y,xlim=c(0,1.5),xaxt='n',yaxt='n', ylim=c(-40,0), col='#4575b4',bg='#4575b477', type='b', pch=25)

plot(b4_profile,y,xlim=c(0,1.5),  ylim=c(-40,0),col='#abd9e9',yaxt='n',
     xaxt='n',bg='#abd9e977', type='b', pch=21)
...
segments(b4_profile+b4_SD,y-epsilon,b4_profile+b4_SD,y+epsilon, col='#abd9e9', lwd=1.8)
par(new=T)
plot(b4_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0), yaxt='n',
     xaxt='n',col='#abd9e9',bg='#abd9e977', type='b', pch=25)

plot(b3_profile,y,xlim=c(0,1.5), ylim=c(-40,0), col='#DDF26B', yaxt='n',
     xaxt='n',bg='#DDF26B77',type='b', pch=21)
...
segments(b3_profile+b3_SD,y-epsilon,b3_profile+b3_SD,y+epsilon, col='#DDF26B', lwd=1.8)
par(new=T)
plot(b3_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0),yaxt='n',
     xaxt='n',col='#DDF26B', bg='#DDF26B77', type='b', pch=25)

plot(b5_profile,y,xlim=c(0,1.5), ylim=c(-40,0), col='#e5e572', yaxt='n',
     xaxt='n',bg='#e5e57277',  type='b', pch=21)
...
segments(b5_profile+b5_SD,y-epsilon,b5_profile+b5_SD,y+epsilon, col='#e5e572', lwd=1.8)
par(new=T)
plot(b5_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0), col='#e5e572', yaxt='n',
     xaxt='n',bg='#e5e57277',type='b', pch=25)

plot(b6_profile,y,xlim=c(0,1.5),  ylim=c(-40,0),col='#fed976', 
     bg='#fed97677', type='b', pch=21)
...
segments(b6_profile+b6_SD,y-epsilon,b6_profile+b6_SD,y+epsilon, col='#fed976', lwd=1.8)
par(new=T)
plot(b6_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0), col='#fed976',
     xaxt='n',yaxt='n', bg='#fed97677',  type='b', pch=25)
mtext(side=2, text='depth (cm)', line=2)

plot(b7_profile,y,xlim=c(0,1.5),  ylim=c(-40,0),col='#f79220',bg='#f7922077',yaxt='n', type='b', pch=21)
...
segments(b7_profile+b7_SD,y-epsilon,b7_profile+b7_SD,y+epsilon, col='#f79220', lwd=1.8)
par(new=T)
plot(b7_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0), col='#f79220',bg='#f7922077', yaxt='n', type='b', pch=25)

plot(b8_profile,y,xlim=c(0,1.5), ylim=c(-40,0), col='#f46d43',bg='#f46d4377',yaxt='n', type='b', pch=21)
...
segments(b8_profile+b8_SD,y-epsilon,b8_profile+b8_SD,y+epsilon, col='#f46d43', lwd=1.8)
par(new=T)
plot(b8_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0), col='#f46d43',yaxt='n',
     bg='#f46d4377',  type='b', pch=25)

plot(b9_profile,y,xlim=c(0,1.5), ylim=c(-40,0), col='#d73027',bg='#d7302777',
     type='b',yaxt='n', pch=21)
...
segments(b9_profile+b9_SD,y-epsilon,b9_profile+b9_SD,y+epsilon, col='#d73027', lwd=1.8)
par(new=T)
plot(b9_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0), yaxt='n',
     col='#d73027',bg='#d7302777', type='b', pch=25)

plot(b10_profile,y,xlim=c(0,1.5), ylim=c(-40,0), col='#a50028',yaxt='n', bg='#a5002877', type='b', pch=21)
...
segments(b10_profile+b10_SD,y-epsilon,b10_profile+b10_SD,y+epsilon, col='#a50028', lwd=1.8)
par(new=T)
plot(b10_profile_mod/1000,y,xlim=c(0,1.5), ylim=c(-40,0),col='#a50028',yaxt='n',  bg='#a5002877', type='b', pch=25)
