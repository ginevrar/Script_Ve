...
setwd('C:/Users/gi/Dropbox/2017_Venice/114/Buona/buonav14')
...
png('sed_bal_v10b.png',width = 30, height = 20, res=300,units = "cm")
par(mfrow=c(2,5))
...
png('DEPO_kgm2y_v10b.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('DEPO_vs_Sarretta___v10b.png',width = 950, height = 530, units = "px")
par(mfrow=c(2,5))
...
png('Net_DEPO_Res__v10b.png',width = 30, height = 20, res=300,units = "cm")
par(mfrow=c(2,5))
