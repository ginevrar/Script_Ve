...
mod2_b01<-read.table('282.2d.1')   
mod2_b02<-read.table('282.2d.2')   
mod2_b03<-read.table('282.2d.3')   
mod2_b04<-read.table('282.2d.4')   
mod2_b06<-read.table('282.2d.5')
mod2_b07<-read.table('282.2d.7')   
mod2_b08<-read.table('282.2d.8')   
mod2_b09<-read.table('282.2d.9')   
mod2_b10<-read.table('282.2d.10')   
mod2_b11<-read.table('282.2d.11')   
mod2_b14<-read.table('282.2d.12')   
mod2_b16<-read.table('282.2d.13')   
mod2_b19<-read.table('282.2d.14')   
mod2_b20<-read.table('282.2d.15')   
mod2_b31<-read.table('282.2d.16')   
mod2_CI<-read.table('282.2d.17')   
mod2_CS<-read.table('282.2d.18')   
#mod2_b19<-read.table('282.2d.19')   
#mod2_b20<-read.table('282.2d.20')   
#mod2_b31<-read.table('282.2d.21')   
#mod2_CI<-read.table('282.2d.22')   
#mod2_CS<-read.table('282.2d.23')   
...
plot(X[23]$C01.Data,X[23]$C01.POCt, type='p')




png('DatiMEla_POM_2005_model_twosimVer.png',width=29, height = 21, units='cm',res=200) 
par(mfrow=c(6,3), mar=c(2.6,2,1,1),oma=c(0,0,4.3,0), cex.axis=1.2)


plot(as.POSIXct.Date(mod_b01[,1]), mod_b01[,2],type='l',lwd=2,
     ylim=c(0,5),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#005E8C')
par(new=T)
...
plot(B01$B01.Data,B01$B01.POC, type='p',lwd=2,
     ylab='*C',xlab = '',
     ylim=c(0,5),col='#00000099', pch=19)
mtext('St. B01, nodo 3765',3)
mtext('POM (mg/l)',3, outer=T, line=2,font=2, cex=1.3)
#text((B01$B01.Data,B01$B01.POC,labels=B01$B01.POC)
legend('topright', pch=19,lty=c(2,1,2,4),
       legend=c('data','venlag62','venlag64'),bty='n',
       col=c('#00000099','#005E8C','darkorange'), cex=1.3)

plot(as.POSIXct.Date(mod_b02[,1]), mod_b02[,2],ylim=c(0,5),
...
plot(as.POSIXct.Date(mod2_b02[,1]), mod2_b02[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B02$B02.Data,B02$B02.POC, type='p',ylim=c(0,5),lwd=2, ylab='*C',xlab = '',
     col='#00000099', pch=19)
mtext('St. B02, nodo 4036',3)

plot(as.POSIXct.Date(mod_b03[,1]), mod_b03[,2],
     ylim=c(0,5.0),pch=19,ylab='*C',xlab = '',type='l',lwd=2,
     xaxt='n',col='#005E8C')
par(new=T)
plot(as.POSIXct.Date(mod2_b03[,1]), mod2_b03[,2],type='l',lwd=2,lty=4,
     ylim=c(0,5.0),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='darkorange')
par(new=T)
plot(B03$B03.Data,B03$B03.POC, type='p',ylim=c(0,5.0),lwd=2, ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b04[,1]), mod2_b04[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B04$B04.Data,B04$B04.POC, type='p',lwd=2,ylim=c(0,5.0), ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b06[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B06$B06.Data,B06$B06.POC, type='p',
     ylim=c(0,5),ylab='*C',xlab = '',lwd=1.5,
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b07[,1]), mod2_b07[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B07$B07.Data,B07$B07.POC, lwd=2,type='p',
     ylim=c(0,5), ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b08[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B08$B08.Data,B08$B08.POC, type='p',lwd=2,ylim=c(0,5),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b09[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B09$B09.Data,B09$B09.POC, type='p',lwd=2,ylim=c(0,5),ylab='*C',xlab = '',
     col='#00000099', pch=19)
mtext('St. B09, nodo 2409',3)

plot(as.POSIXct.Date(mod_b10[,1]), mod_b10[,2],
     ylim=c(0,5.0),pch=19,ylab=' ',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b10[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B10$B10.Data,B10$B10.POC, type='p',lwd=2,
     ylim=c(0,5.0), ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b11[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B11$B11.Data,B11$B11.POC, type='p',lwd=2,ylim=c(0,5.0),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]),mod2_b14[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B14$B14.Data,B14$B14.POC, type='p',lwd=2,
     ylim=c(0,5),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b16[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B16$B16.Data,B16$B16.POC, type='p',lwd=2,ylim=c(0,5), ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b17[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B17$B17.Data,B17$B17.POC, type='p',lwd=2,ylim=c(0,5),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b18[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B19$B19.Data,B19$B19.POC, type='p',ylim=c(0,5),
     ylab='*C',xlab = '',lwd=1.5,
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b20[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B20$B20.Data,B20$B20.POC, type='p',lwd=2,
     ylim=c(0,5),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b31[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B31$B31.Data,B31$B31.POC, type='p',lwd=2,ylim=c(0,5),ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_CI[,1]), mod2_CI[,2],type='l',
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(CI$CI.Data,CI$CI.POC, type='p',lwd=2,ylim=c(0,5),
     ylab='*C',xlab = '',
     col='#00000099', pch=19)
...
plot(as.POSIXct.Date(mod2_CS[,1]), mod2_CS[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(CS$CS.Data,CS$CS.POC, type='p',lwd=2,ylim=c(0,5),ylab='*C',xlab = '',
     col='#00000099', pch=19)
