...
fd3_kgy<-(flux3*86400)/10^9   ## ug m-3 s-1 
fd4_kgy<-(flux4*86400)/10^9   ## ug m-3 s-1 
fd5_kgy<-(flux5*86400)/10^9   ## ug m-3 s-1 
fd6_kgy<-(flux6*86400)/10^9   ## ug m-3 s-1 
fd7_kgy<-(flux7*86400)/10^9   ## ug m-3 s-1 
fd8_kgy<-(flux8*86400)/10^9   ## ug m-3 s-1 
fd9_kgy<-(flux9*86400)/10^9   ## ug m-3 s-1 
fd10_kgy<-(flux10*86400)/10^9   ## ug m-3 s-1 
...
fd1_kgy_mhgd<-(flux1_mhgd*86400)/10^9   ## ug m-3 s-1 
fd2_kgy_mhgd<-(flux2_mhgd*86400)/10^9   ## ug m-3 s-1 
fd3_kgy_mhgd<-(flux3_mhgd*86400)/10^9   ## ug m-3 s-1 
fd4_kgy_mhgd<-(flux4_mhgd*86400)/10^9   ## ug m-3 s-1 
fd5_kgy_mhgd<-(flux5_mhgd*86400)/10^9   ## ug m-3 s-1 
fd6_kgy_mhgd<-(flux6_mhgd*86400)/10^9   ## ug m-3 s-1 
fd7_kgy_mhgd<-(flux7_mhgd*86400)/10^9   ## ug m-3 s-1 
fd8_kgy_mhgd<-(flux8_mhgd*86400)/10^9   ## ug m-3 s-1 
fd9_kgy_mhgd<-(flux9_mhgd*86400)/10^9   ## ug m-3 s-1 
fd10_kgy_mhgd<-(flux10_mhgd*86400)/10^9   ## ug m-3 s-1 
