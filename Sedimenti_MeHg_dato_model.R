...
#DAti 
BOX1<-c(1.42,0.54) 
BOX2<-c(1.90,1.48,2.47,	1.16,1.11,	
        2.18,0.61	,0.64,0.56,	1.04,	1.43,
        0.63,0.37,	0.58,	0.70,	0.64)

BOX3<-c(0.34,0.13)
BOX6<-c(1.80,	1.26829,0.84,	0.829268,1.16129,
        0.822581,0.62, 0.46, 0.84,0.18)
BOX7<-c(0.23,0.49,0.63, 0.51,1.4,0.11) 
...
plot(rdate[241:1467],mehg$sn1[241:1467],ylim=c(0,4), lty=3,
     type='l', col='#31369577',lwd=1.5, main='Box1', 
     ylab='MeHg (ng/g)',xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dsn1[241:1467],ylim=c(0,4), 
...
plot(rdate[241:1467],mehg$osn1[241:1467],
     ylim=c(0,4), type='l', col='#31369577',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
boxplot(BOX1,ylim=c(0,4),col='#31369577',xlim=c(0,2),at=1.7,
        ylab=' ',boxwex=.5, xaxt='n',yaxt='n')
par(new=T)
plot(rdate[241:1467],media1[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='Box1',xaxt='n',yaxt='n', 
     ylab='MeHg (ng/g)',xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=2)
mtext('MeHg (ng/g)', side = 2, line=2.9, cex=1.2)

plot(rdate[241:1467],mehg$sn2[241:1467],ylim=c(0,4),
     type='l', col='#4575b4',lwd=1.5,main='Box2',ylab= '',
     xlab= '', cex.lab=1.5 , lty=3,cex.main=1.3  , cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dsn2[241:1467],ylim=c(0,4), 
     type='l', col='#4575b4',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$osn2[241:1467],
     ylim=c(0,4), type='l', col='#4575b4',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
bb<-boxplot(BOX2,ylim=c(0,4),col='#4575b477',
            boxwex=.5, xlim=c(0,2),at=1.7,
            xaxt='n',ylab= '',yaxt='n')
par(new=T)
plot(rdate[241:1467],media2[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)

 
plot(rdate[241:1467],mehg$sn4[241:1467], ylim=c(0,4),
     type='l',col='#abd9e9',lwd=1.5,main='Box4',
     xlab= '',ylab= '', cex.lab=1.5 ,lty=3, cex.main=1.3  , 
     cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dsn4[241:1467],ylim=c(0,4), 
     type='l', col='#abd9e9',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$osn4[241:1467],
     ylim=c(0,4), type='l', col='#abd9e9',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],media4[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab='MeHg (ng/l)',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)

 
plot(rdate[241:1467],mehg$sn3[241:1467], ylim=c(0,4),lty=3,
     type='l', col='#DDF26B',lwd=1.5,main='Box3',
     xlab= '', ylab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dsn3[241:1467],ylim=c(0,4), 
     type='l', col='#DDF26B',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$osn3[241:1467],
     ylim=c(0,4), type='l', col='#DDF26B',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
boxplot(BOX3,ylim=c(0,4),col='#DDF26B',
         xaxt='n', boxwex=.5, xlim=c(0,2),at=1.7,
        ylab= 'MeHg (ng/l)',yaxt='n')
par(new=T)
plot(rdate[241:1467],media3[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)

 
plot(rdate[241:1467],mehg$sn5[241:1467], ylim=c(0,4), 
     type='l',col='#e5e572',lwd=1.5, main='Box5',lty=3,
     xlab= '',ylab= 'MeHg (ng/l)', cex.lab=1.5 , cex.main=1.3  , cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dsn5[241:1467],ylim=c(0,4), 
     type='l', col='#e5e572',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$osn5[241:1467],
     ylim=c(0,4), type='l', col='#e5e572',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],media5[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)
...
plot(rdate[241:1467],mehg$sc6[241:1467], 
     ylim=c(0,4), type='l',col='#fed976',lwd=1.5,
     main='Box6',lty=3,
     ylab='MeHg (ng/l)',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)#
par(new=T)
plot(rdate[241:1467], mehg$dsc6[241:1467],ylim=c(0,4), 
     type='l', col='#fed976',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$osc6[241:1467],
     ylim=c(0,4), type='l', col='#fed976',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
boxplot(BOX6,ylim=c(0,4),col='#fed97677',
        ylab=' ', boxwex=.5, xlim=c(0,2),at=1.7,
        xaxt='n', yaxt='n')
par(new=T)
plot(rdate[241:1467],media6[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)
mtext('MeHg (ng/g)', side = 2, line=2.9, cex=1.2)
...
plot(rdate[241:1467],mehg$sc7[241:1467], lty=3,
     ylim=c(0,4), type='l',ylab= 'MeHg (ng/l)',
     col='#f79220',lwd=1.5,
     main='Box7',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dsc7[241:1467],ylim=c(0,4), 
     type='l', col='#f79220',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$osc7[241:1467],
     ylim=c(0,4), type='l', col='#f79220',
     lty=5,lwd=1,main=' ',ylab= '', xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
boxplot(BOX7,ylim=c(0,4),col='#f7922077',
        ylab= '',boxwex=.5, xlim=c(0,2),at=1.7,
        xaxt='n',yaxt='n')#
par(new=T)
plot(rdate[241:1467],media7[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)
...
plot(rdate[241:1467],mehg$ss8[241:1467],lty=3,
     ...
     xlab= '', cex.lab=1.5 , cex.main=1.3 ,  cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dss8[241:1467],ylim=c(0,4), 
     type='l', col='#f46d43',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$oss8[241:1467],
     ylim=c(0,4), type='l', col='#f46d43',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],media8[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)
...
plot(rdate[241:1467],mehg$ss9[241:1467], lty=3,
     ylim=c(0,4), type='l',col='#d73027',ylab= '',lwd=1.5, main='Box9',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=2)
par(new=T)
plot(rdate[241:1467], mehg$dss9[241:1467],ylim=c(0,4), 
     type='l', col='#d73027',xaxt='n',yaxt='n',
     lty=1,lwd=1.5,main=' ',ylab= '',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],mehg$oss9[241:1467],
     ylim=c(0,4), type='l', col='#d73027',
     lty=5,lwd=1,main=' ',ylab= 'MeHg (ng/l)',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],media9[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)
 
plot(rdate[241:1467],mehg$ss10[241:1467],lty=3,
     ylim=c(0,4), type='l',col='#a50028',ylab= '',lwd=1.5, main='Box10',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=2)
par(new=T)
...
plot(rdate[241:1467],mehg$oss10[241:1467],
     ylim=c(0,4), type='l', col='#a50028',
     lty=5,lwd=1,main=' ',ylab= '',xaxt='n',yaxt='n',
     xlab= '', cex.lab=1.5 , cex.main=1.3  , cex.axis=1.4)
par(new=T)
plot(rdate[241:1467],media10[241:1467],ylim=c(0,4), lty=1,
     type='l', col=1,lwd=1.5, main='',xaxt='n',yaxt='n',
     ylab=' ',xlab= '', cex.lab=1.5 , 
     cex.main=1.3  , cex.axis=2)
