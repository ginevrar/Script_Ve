...
png('DatiMEla_SOM_2005_model_twosimVer_10795.png',width=29, height = 21, units='cm',res=200) 
par(mfrow=c(6,3), mar=c(2.6,2,1,1),oma=c(0,4,4.3,0), cex.axis=1.2)

plot(B01$B01.Data,B01$B01.TSS,cex=1.5, type='p',lwd=1,
     ylab='*C',xlab = '',
     ylim=c(0,120),col='#00000000', pch=19)
...
legend(B01$B01.Data[1],123, pch=19,lty=c(2,1,2,4),
       legend=c('data','sim 107','sim 95'),bty='n',
