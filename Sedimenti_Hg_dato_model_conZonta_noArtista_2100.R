...
plot(rdate[2: 2427],hg$sn1[2: 2427],ylim=c(-50,5000),
...
plot(rdate[2: 2427],hg$dsn1[2: 2427],ylim=c(-50,5000), type='l', col='#313695',
     ...
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
plot(rdate[2: 2427],hg$osn1[2: 2427],ylim=c(-50,5000), type='l', col='#313695',
...
plot(rdate[2: 2427],hg$dsn2[2: 2427],ylim=c(-50,5000), type='l', col='#4575b4',
     ...
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
plot(rdate[2: 2427],hg$osn2[2: 2427],ylim=c(-50,5000), type='l', col='#4575b4',
...
par(new=T)
plot(rdate[2: 2427],media2[2: 2427],ylim=c(-50,5000), type='l', col='gray10',
     lwd=1, main=' ', 
...
par(new=T)
plot(rdate[2: 2427],hg$osn4[2: 2427], ylim=c(-50,5000),lty=5, type='l',
...
boxplot(box4_77, box4, box4_A_hg$Hg, ylim=c(-50,5000),
        ...
        boxwex=1700,xaxt='n',ylab= '',yaxt='n')
par(new=T)
plot(rdate[2: 2427],media4[2: 2427],ylim=c(-50,5000), type='l', col='gray10',
     lwd=1.5, main=' ', 
...
par(new=T)  
plot(rdate[2: 2427],media3[2: 2427],ylim=c(-50,5000), type='l', col='gray10',
...
par(new=T)
plot(rdate[2: 2427],media5[2: 2427],ylim=c(-50,5000), type='l',
...
#par(mar=c(3,5,2,0))   
plot(rdate[2: 2427],hg$sc6[2: 2427], ylim=c(-50,5000),
...
par(new=T)
plot(rdate[2: 2427],media6[2: 2427],ylim=c(-50,5000), type='l', col='gray10',lwd=1.5, 
...
boxplot(box7_77,box7,box7_A_hg$Hg,ylim=c(-50,5000),col='#f7922088',
        ...
        ylab= '',boxwex=1700,xaxt='n',yaxt='n' , range=F)#
par(new=T)
plot(rdate[2: 2427],media7[2: 2427],ylim=c(-50,5000), type='l', col='gray10',
...
plot(rdate[2: 2427],hg$dss8[2: 2427], ylim=c(-50,5000), type='l',ylab= '',yaxt='n',
     ...
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
plot(rdate[2: 2427],hg$oss8[2: 2427], ylim=c(-50,5000),lty=5,
...
par(new=T)
plot(rdate[2: 2427],media8[2: 2427],ylim=c(-50,5000), type='l', col='gray10',
...
plot(rdate[2: 2427],hg$dss9[2: 2427], ylim=c(-50,5000), type='l',col='#d73027',ylab= '',
     ...
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
plot(rdate[2: 2427],hg$oss9[2: 2427], ylim=c(-50,5000),lty=5, 
...
par(new=T)
plot(rdate[2: 2427],media9[2: 2427],ylim=c(-50,5000), type='l', col='gray10',lwd=1.5,
     main=' ', ylab='Hg (ng/g)',xlab= '', cex.lab=2 ,yaxt='n', 
     cex.main=1.7 , lty=1,cex.axis=1.6)

plot(rdate[2: 2427],hg$ss10[2: 2427], ylim=c(-50,5000), 
     type='l',col='#a50028',
...
plot(rdate[2: 2427],hg$dss10[2: 2427], ylim=c(-50,5000),
     ...
     xlab= '', cex.lab=2 , cex.main=1.7 , cex.axis=1.6)
par(new=T)
plot(rdate[2: 2427],hg$oss10[2: 2427], ylim=c(-50,5000),lty=5, 
