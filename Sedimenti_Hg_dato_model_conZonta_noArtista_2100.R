setwd('C:/Users/Acer/Desktop/baba/buona/double_in/NNN64')
...
png('Time_hg_sediment_fin92b_oks_buona48_2100bc.png',
...
boxplot(box1_77,box1,Zonta1,ylim=c(-50,5000),
        ...
        boxwex=2700, xaxt='n',yaxt='n', xlim=c(rdate[2],rdate[2427]),
