...
png('Hg_water_fin91cc_.png',width = 32, height = 18,res=400,units = "cm")
...
plot(nord_year_median, type='b', pch=24, main='northern area',
     ylim=c(0,60),xlim=c(0.7,12.3), ylab='ng/L', xlab='', 
...
boxplot(cnord1$Hg1,cnord2$Hg1, cnord3$Hg1, cnord4$Hg1,cnord5$Hg1, cnord6$Hg1,
        cnord7$Hg1,cnord8$Hg1,cnord9$Hg1,cnord10$Hg1,cnord11$Hg1,cnord12$Hg1, ylim=c(0,60),
        ylab='', xlab='', xlim=c(0.7,12.3), col='#e5e57299',varwidth=T)		

par(new=T)
plot(c_nord_year_median, type='b',xaxt='n', pch=24,ylim=c(0,60),xlim=c(0.7,12.3), 
...
plot(c_sud_year_median, type='b', pch=24,xaxt='n',cex=2, main='central southern area',
     ylab='ng/L', xlab='', ylim=c(0,60),xlim=c(0.7,12.3), lwd=1, col=1,bg='#d1740c99')
...
plot(sud_year_mean,  type='b', main='southern area',
     ylim=c(0,60),pch=24,xaxt='n',cex=2, ylab='ng/L', xlab='',
...
boxplot(nord1$Hg1,nord_jan, nord2$Hg1,nord_feb, nord3$Hg1,nord_mar,
        ...
        nord10$Hg1,nord_oct, nord11$Hg1,nord_nov,nord12$Hg1,nord_dec, ylim=c(0,60),
        xlim=c(0.7,12.3), col=c('#4575b499','#4575b422'),varwidth=T)
par(new=T)
plot(nord_year_median, type='b', pch=24, ylim=c(0,60),xlim=c(0.7,12.3), 
     xaxt='n',lwd=1, col='black',bg='#2d4c7599', cex=2)
par(new=T)
plot(nord_year_mean, type='b', pch=19, ylim=c(0,60),xlim=c(0.7,12.3), 
     xaxt='n',lwd=1, col='black',bg='#2d4c7599', cex=2)
