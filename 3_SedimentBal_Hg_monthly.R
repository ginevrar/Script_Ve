...
res1_hg_ug_m2_d<-res_media1*Phgs$sn1#/porosity$sn1   #m d-1 * ug m-3   = ug m-2 d
res2_hg_ug_m2_d<-res_media2*Phgs$sn2#/porosity$sn2     #m d-1 * ug m-3   = ug m-2 d
res3_hg_ug_m2_d<-res_media3*Phgs$sn3#/porosity$sn3    #m d-1 * ug m-3   = ug m-2 d
res4_hg_ug_m2_d<-res_media4*Phgs$sn4#/porosity$sn4   #m d-1 * ug m-3   = ug m-2 d
res5_hg_ug_m2_d<-res_media5*Phgs$sn5#/porosity$sn5    #m d-1 * ug m-3   = ug m-2 d
res6_hg_ug_m2_d<-res_media6*Phgs$sc6#/porosity$sc6   #m d-3 * ug m-1   = ug m-2 d
res7_hg_ug_m2_d<-res_media7*Phgs$sc7#/porosity$sc7    #m d-1 * ug m-3   = ug m-2 d
res8_hg_ug_m2_d<-res_media8*Phgs$ss8#/porosity$ss8    #m d-1 * ug m-3   = ug m-2 d
res9_hg_ug_m2_d<-res_media9*Phgs$ss9#/porosity$ss9#m d-1 * ug m-3   = ug m-2 d
res10_hg_ug_m2_d<-res_media10*Phgs$ss10#/porosity$ss10   #m d-1 * ug m-3   = ug m-2 d
...
plot(Hg_depo_tot,col='blue' ,type='l', ylim=c(0,500))
par(new=T)
