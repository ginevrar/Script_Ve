...
png('OC_perc_fin92b__oksMMM9.png',width = 30, height = 20, units = "cm", res=300)
par(mfrow=c(2,5))
plot(rdate[480:1440],OC_perc$sn1[480:1440],col='#313695',type='l', lwd=2, ylim=c(0,10))
par(new=T)
plot(rdate[480:1440],OC1[480:1440],col=c('#313695'),
     type='p', lwd=2, cex=2, 
     lty=2,ylim=c(0,10))
segments(rdate[1306],max(box1_A_OC),rdate[1306], min(box1_A_OC),col='#313695')

plot(rdate[480:1440],OC_perc$sn2[480:1440],col='#4575b4',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$sn4[480:1440],col='#abd9e9',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$sn3[480:1440],col='#DDF26B',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$sn5[480:1440],col='#e5e572',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$sc6[480:1440],col='#fed976',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$sc7[480:1440],col='#f79220',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$ss8[480:1440],col='#f46d43',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$ss9[480:1440],col='#d73027',type='l', lwd=2, ylim=c(0,10))
par(new=T)
...
plot(rdate[480:1440],OC_perc$ss10[480:1440],col='#a50028',type='l', lwd=2, ylim=c(0,10))
par(new=T)
