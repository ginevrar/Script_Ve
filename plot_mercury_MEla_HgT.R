...
mod_hgT_b01<-mod_hgII_b01[,2]+mod_mehg_b01[,2]+mod_hg0_b01[,2]
mod_hgT_b02<-mod_hgII_b02[,2]+mod_mehg_b02[,2]+mod_hg0_b02[,2]
mod_hgT_b03<-mod_hgII_b03[,2]+mod_mehg_b03[,2]+mod_hg0_b03[,2]
mod_hgT_b04<-mod_hgII_b04[,2]+mod_mehg_b04[,2]+mod_hg0_b04[,2]
mod_hgT_b05<-mod_hgII_b05[,2]+mod_mehg_b05[,2]+mod_hg0_b05[,2]
mod_hgT_b06<-mod_hgII_b06[,2]+mod_mehg_b06[,2]+mod_hg0_b06[,2]
mod_hgT_b07<-mod_hgII_b07[,2]+mod_mehg_b07[,2]+mod_hg0_b07[,2]
mod_hgT_b08<-mod_hgII_b08[,2]+mod_mehg_b08[,2]+mod_hg0_b08[,2]
mod_hgT_b09<-mod_hgII_b09[,2]+mod_mehg_b09[,2]+mod_hg0_b09[,2]
mod_hgT_b10<-mod_hgII_b10[,2]+mod_mehg_b10[,2]+mod_hg0_b10[,2]
mod_hgT_b11<-mod_hgII_b11[,2]+mod_mehg_b11[,2]+mod_hg0_b11[,2]
mod_hgT_b12<-mod_hgII_b12[,2]+mod_mehg_b12[,2]+mod_hg0_b12[,2]
mod_hgT_b13<-mod_hgII_b13[,2]+mod_mehg_b13[,2]+mod_hg0_b13[,2]
mod_hgT_b14<-mod_hgII_b14[,2]+mod_mehg_b14[,2]+mod_hg0_b14[,2]
mod_hgT_b15<-mod_hgII_b15[,2]+mod_mehg_b15[,2]+mod_hg0_b15[,2]
mod_hgT_b16<-mod_hgII_b16[,2]+mod_mehg_b16[,2]+mod_hg0_b16[,2]
mod_hgT_b17<-mod_hgII_b17[,2]+mod_mehg_b17[,2]+mod_hg0_b17[,2]
mod_hgT_b18<-mod_hgII_b18[,2]+mod_mehg_b18[,2]+mod_hg0_b18[,2]
mod_hgT_b19<-mod_hgII_b19[,2]+mod_mehg_b19[,2]+mod_hg0_b19[,2]
mod_hgT_b20<-mod_hgII_b20[,2]+mod_mehg_b20[,2]+mod_hg0_b20[,2]
mod_hgT_b31<-mod_hgII_b31[,2]+mod_mehg_b31[,2]+mod_hg0_b31[,2]
mod_hgT_CI<-mod_hgII_CI[,2]+mod_mehg_CI[,2]+mod_hg0_CI[,2]
mod_hgT_CS<-mod_hgII_CS[,2]+mod_mehg_CS[,2]+mod_hg0_CS[,2]
...
png('DatiMEla_Hg2005_ver.png',width=29, height = 21, units='cm',res=200) 
par(mfrow=c(6,3), mar=c(2.6,2,1,1),oma=c(0,0,4.3,0), cex.axis=1.2)

plot(as.POSIXct.Date(mod_hgII_b01[,1]), mod_hgT_b01,
...
plot(as.POSIXct.Date(mod_hgII_b02[,1]), mod_hgT_b02,
     type='l',lwd=1.5,
     ylim=c(0,40),ylab='SPM (mg/l)',xlab = '',
     xaxt='n',pch=19,col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b03[,1]), mod_hgT_b03,type='l',lwd=1.5,
...
plot(as.POSIXct.Date(mod_hgII_b04[,1]), mod_hgT_b04,type = 'l',lwd=1.2,
...
plot(as.POSIXct.Date(mod_hgII_b06[,1]), mod_hgT_b06,type = 'l',lwd=1.5,
...
plot(as.POSIXct.Date(mod_hgII_b07[,1]), mod_hgT_b07 ,type='l',
...
plot(as.POSIXct.Date(mod_hgII_b08[,1]), mod_hgT_b08,type = 'l',lwd=1.5,
     ylim=c(0,60),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b09[,1]), mod_hgT_b09,type = 'l',lwd=1.5,
...
plot(as.POSIXct.Date(mod_hgII_b10[,1]), mod_hgT_b10,type = 'l',lwd=1.5,
     ylim=c(0,50),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b11[,1]), mod_hgT_b11,type = 'l',lwd=1.5,
...
plot(as.POSIXct.Date(mod_hgII_b14[,1]), mod_hgT_b14,type = 'l',lwd=1.5,
     ylim=c(0,40),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b16[,1]), mod_hgT_b16,type = 'l',lwd=1.5,
     ylim=c(0,30),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b17[,1]), mod_hgT_b17,type = 'l',lwd=1.5,
     ylim=c(0,30),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b19[,1]), mod_hgT_b19,type = 'l',lwd=1.5,
     ylim=c(0,30),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b20[,1]), mod_hgT_b20,type = 'l',lwd=1.5,
     ylim=c(0,30),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_b31[,1]), mod_hgT_b31,type = 'l',lwd=1.5,
     ylim=c(0,30),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_CI[,1]), mod_hgT_CI,type = 'l',lwd=1.5,
     ylim=c(0,100),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
...
plot(as.POSIXct.Date(mod_hgII_CS[,1]), mod_hgT_CS,type = 'l',lwd=1.5,
     ylim=c(0,100),pch=19,ylab='SPM (mg/l)',xlab = '',
     xaxt='n',col='#00000066')
par(new=T)
