...
plot(rdate[241:1467], solid$wn1[241:1467] ,    type='l', col='#313695',lwd=2, main='Box1', 
     ylab='SPM (mg/L)',xlab= '', cex.lab=2 , 
     cex.main=2 , cex.axis=1.3, ylim=c(0,60))
par(new=T)
boxplot(SPM$BOX1, col='#31369566', ylim=c(0,60),
        at=c(2.4),xlim=c(0,3),
        xaxt='n',yaxt='n') 

#plot(empty1_v05, ylim=c(0,2000), type='p',pch=25,col='#10178c',lwd=2)
par(mar=c(3,3,2,1))
plot(rdate[241:1467] ,solid$wn2[241:1467] ,    type='l', col='#4575b4',lwd=2,main='Box2',ylab= '',
     xlab= '', cex.lab=2 , cex.main=2 , cex.axis=1.3,ylim=c(0,60))
par(new=T)
boxplot(SPM$BOX2, at=c(2.4),xlim=c(0,3),col='#4575b466', ylim=c(0,60), xaxt='n',yaxt='n') 
#
plot(rdate[241:1467],solid$wn4[241:1467],   type='l',col='#abd9e9',lwd=2,main='Box4',
     xlab= '',ylab= '', cex.lab=2 , cex.main=2 , ylim=c(0,60),cex.axis=1.3)
#par(new=T)
#boxplot(SPM$BOX4, col='#4575b466', ylim=c(0,40), xaxt='n',yaxt='n') 
plot(rdate[241:1467],solid$wn3[241:1467],     type='l',col='#f7df9e',lwd=2,main='Box3',
     xlab= '',ylab= '', cex.lab=2 , ylim=c(0,60), cex.main=2 , cex.axis=1.3)
par(new=T)
boxplot(SPM$BOX3, at=c(2.4),xlim=c(0,3), col='#f7df9e66', ylim=c(0,60), xaxt='n',yaxt='n') 

plot(rdate[241:1467] ,solid$wn5[241:1467],     type='l',col='#f7d067',lwd=2, main='Box5',
     xlab= '',ylab= '', cex.lab=2 , cex.main=2 , cex.axis=1.3,ylim=c(0,60))
par(new=T)
boxplot(SPM$BOX5, at=c(2.4),xlim=c(0,3),col='#f7df9e66', ylim=c(0,60), xaxt='n',yaxt='n') 

par(mar=c(3,4.5,2,0))
plot(rdate[241:1467] ,solid$wc6[241:1467],     type='l',col='#edba55',lwd=2, main='Box6',
     ylab='SPM (mg/L) ',xlab= '', cex.lab=2 , 
     cex.main=2 ,ylim=c(0,60), cex.axis=1.3)#
par(new=T)
boxplot(SPM$BOX6, at=c(2.4),xlim=c(0,3),col='#edba5566', ylim=c(0,60), xaxt='n',yaxt='n') 

plot(rdate[241:1467] ,solid$wc7[241:1467] ,     type='l',col='#f79220',lwd=2, main='Box7',
     ylab='',xlab= '', cex.lab=2 , cex.main=2 ,ylim=c(0,60), cex.axis=1.3)#
par(new=T)
boxplot(SPM$BOX7, at=c(2.4),xlim=c(0,3),col='#f7922066', ylim=c(0,60), xaxt='n',yaxt='n') 

plot(rdate[241:1467] ,solid$ws8[241:1467] ,     type='l',ylab= '', col='#f46d43',lwd=2, main='Box8',
     xlab= '', cex.lab=2 , cex.main=2 , ylim=c(0,60), cex.axis=1.3)
par(new=T)
boxplot(SPM$BOX8, at=c(2.4),xlim=c(0,3), col='#f46d4366', ylim=c(0,60), xaxt='n',yaxt='n') 

plot(rdate[241:1467] ,solid$ws9[241:1467] ,     type='l',col='#d73027',ylab= '',lwd=2, main='Box9',
     xlab= '', cex.lab=2 , cex.main=2 , ylim=c(0,60), cex.axis=1.3)
par(new=T)
boxplot(SPM$BOX9,  at=c(2.4),xlim=c(0,3),col='#d7302766', ylim=c(0,60), xaxt='n',yaxt='n') 
plot(rdate[241:1467],solid$ws10[241:1467],     
     type='l',col='#a50028',ylab= '',lwd=2, main='Box10',
     cex.main=2 , cex.axis=1.3, ylim=c(0,60))
par(new=T)
boxplot(SPM$BOX10, at=c(2.4),xlim=c(0,3), col='#a5002866', ylim=c(0,60), xaxt='n',yaxt='n') 
dev.off()


par(mfrow=c(1,1))
#png('silt_sed_2.png',width = 700, height = 480, units = "px")
par(mfrow=c(5,2), mar=c(3,4.5,2,0))
plot(rdate, silt$sn1 ,    type='l', col='#313695',lwd=2,
     main='Box1', 
     ylab='SPM (mg/L)',xlab= '', cex.lab=2 , 
     cex.main=2 , cex.axis=1.3)
