...
b6_depo_2014 <-b6_depo_2014_gm2d*365/1000   #kg DW m2y
  ...
  yy1<-c(-1.5,-1.5,1.5,1.5)
  
  png('DEPO_vs_Sarretta_fin92b__oksMMM9chilm___bnnx.png',width = 30, height = 20, units = "cm", res=300)
  par(mfrow=c(2,5))
  plot(rdate[3:203],netdepo_sed1[3:203], type='l',ylim=c(-1.6,1.6), xlab=' ', ylab='cm y-1',
       col='#00000000', lwd=2)
   polygon(H_resus,yy1, col='#68676733',border = NA)
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b2,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2), ylab=' ', lwd=2,border = '#313695',col='#31369599')
  par(new=T)
  plot(rdate[3:203],netdepo_sed1[3:203], type='l', xlab=' ', ylab='cm y-1',ylim=c(-1.6,1.6), col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  
  plot(rdate[3:203],netdepo_sed1[3:203], type='l',ylim=c(-1.6,1.6),  xlab=' ', ylab='cm y-1',col='#00000000', lwd=2)
  polygon(H_resus,yy1, col='#68676733',border = NA)
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b2,ylim=c(-1.6,1.6), xaxt='n',lwd=2, xlim=c(0,2), border = '#4575b4',col='#4575b499')
  par(new=T)
  plot(rdate[3:203],netdepo_sed2[3:203], ylim=c(-1.6,1.6),type='l', xlab=' ', ylab='cm y-1', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b4,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2), border = '#abd9e9',col='#abd9e999')
  par(new=T)
  plot(rdate[3:203],netdepo_sed4[3:203],ylim=c(-1.6,1.6),  type='l',xlab=' ',  ylab='cm y-1', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b3,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2),border = '#DDF26B',col='#DDF26B99')
  par(new=T)
  plot(rdate[3:203],netdepo_sed3[3:203],ylim=c(-1.6,1.6), type='l',xlab=' ',  ylab='cm y-1', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b5,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2), border = '#e5e572',col='#e5e57299')
  par(new=T)
  plot(rdate[3:203],netdepo_sed5[3:203], ylim=c(-1.6,1.6), xlab=' ', type='l', ylab='cm y-1', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b6,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2), xlab=' ', border = '#fed976',col='#fed97699')
  par(new=T)
  plot(rdate[3:203],netdepo_sed6[3:203], type='l',xlab=' ',  ylab='cm y-1',ylim=c(-1.6,1.6), col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b7,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2),  border = '#f79220',col='#f7922099')
  par(new=T)
  plot(rdate[3:203],netdepo_sed7[3:203], ylim=c(-1.6,1.6),xlab=' ', type='l',ylab='cm y-1', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b8,ylim=c(-1.6,1.6), xaxt='n', xlim=c(0,2), border = '#f46d43',col='#f46d4399')
  par(new=T)
  plot(rdate[3:203],netdepo_sed8[3:203],ylim=c(-1.6,1.6), xlab=' ', ylab='cm y-1',type='l', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b9,ylim=c(-1.6,1.6), xaxt='n', border = '#d73027',xlim=c(0,2), col='#d7302799')
  par(new=T)
  plot(rdate[3:203],netdepo_sed9[3:203], ylim=c(-1.6,1.6),xlab=' ', type='l', ylab='cm y-1',col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
  ...
  polygon(Eutrop,yy1, col='#3a871f44',border = NA)
  par(new=T)
  boxplot(sar_b10,ylim=c(-1.6,1.6), xaxt='n', border = '#a50028',xlim=c(0,2), col='#a5002899')
  par(new=T)
  plot(rdate[3:203],netdepo_sed10[3:203],ylim=c(-1.6,1.6),xlab=' ',  type='l',ylab='cm y-1', col=1, lwd=2)
  abline(h=0, lty=3, col='darkgrey', lwd=1.2)
