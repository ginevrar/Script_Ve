...
png('Hg_sediment_zontaaaaaaa_fin5d_9__.png',width = 21, height = 23,
    units = "cm", res=400)
...
plot(rdate[1284:1320],hg$la1[1284:1320],ylim=c(0,2000),
     ...
     lwd=2,lty=1, xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box1_A_hg,ylim=c(0,2000),col='#31369577', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box1',side=2, line=2.7, las=2)
mtext('layer A',side=3, lty=.6)
mean_1A<-rep(NA,37)
mean_1A[19]<-mean(box1_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_1A, col="grey40",bg="grey90", ylim=c(0,2000), ylab  ='',xlab  ='',
     pch=23,cex=1.5,xaxt='n',yaxt='n')

plot(rdate[1284:1320],hg$lb1[1284:1320],ylim=c(0,2000),
     type='l', col='#313695', ylab=' ', lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box1_B_hg,ylim=c(0,2000), col='#31369577',xaxt='n', boxwex=0.4,yaxt='n')
mtext('layer B',side=3, lty=.6)
mean_1B<-rep(NA,37)
mean_1B[19]<-mean(box1_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_1B, col="grey40",bg="grey90",ylab  ='',xlab  ='', ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la2[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box2_A_hg,ylim=c(0,2000),col='#4575b477', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box2',side=2, line=2.7,las=2)
mean_2A<-rep(NA,37)
mean_2A[19]<-mean(box2_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_2A, col="grey40",bg="grey90",ylab  ='',xlab  ='', ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$lb2[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box2_B_hg,ylim=c(0,2000),col='#4575b477', xaxt='n', boxwex=0.4,yaxt='n')
mean_2B<-rep(NA,37)
mean_2B[19]<-mean(box2_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_2B, col="grey40",bg="grey90",ylab  ='', xlab  ='', ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la4[1284:1320],ylim=c(0,2000),
     type='l', col='#abd9e9', ylab=' ',
     lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box4_A_hg,ylim=c(0,2000),col='#abd9e977', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box4',side=2, line=2.7, las=2)
mean_4A<-rep(NA,37)
mean_4A[19]<-mean(box4_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_4A, ylab  ='',xlab  ='', col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$lb4[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box4_B_hg,ylim=c(0,2000),col='#abd9e977', xaxt='n', boxwex=0.4,yaxt='n')
mean_4B<-rep(NA,37)
mean_4B[19]<-mean(box4_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_4B, col="grey40",bg="grey90",ylab  ='',xlab  ='', ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la3[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box3_A_hg,ylim=c(0,2000),col='#DDF26B77', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box3',side=2, line=2.7, las=2)
mean_3A<-rep(NA,37)
mean_3A[19]<-mean(box3_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_3A, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')

plot(rdate[1284:1320],hg$lb3[1284:1320],ylim=c(0,2000),
     type='l', col='#DDF26B', ylab=' ', lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box3_B_hg,ylim=c(0,2000),col='#DDF26B77', xaxt='n', boxwex=0.4,yaxt='n')
mean_3B<-rep(NA,37)
mean_3B[19]<-mean(box3_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_3B, col="grey40",bg="grey90",ylab  ='',xlab  ='',
     ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la5[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box5_A_hg,ylim=c(0,2000), col='#e5e57277',xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box5',side=2, line=2.7, las=2)
mean_5A<-rep(NA,37)
mean_5A[19]<-mean(box5_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_5A, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$lb5[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box5_B_hg,ylim=c(0,2000),col='#e5e57277', xaxt='n', boxwex=0.4,yaxt='n')
mean_5B<-rep(NA,37)
mean_5B[19]<-mean(box5_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_5B, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la6[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box6_A_hg,ylim=c(0,2000),col='#fed97677', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box6',side=2, line=2.7, las=2)
mean_6A<-rep(NA,37)
mean_6A[19]<-mean(box6_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_6A, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')

plot(rdate[1284:1320],hg$lb6[1284:1320],ylim=c(0,2000),
     type='l', col='#fed976', ylab=' ', lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box6_B_hg,ylim=c(0,2000),col='#fed97677', xaxt='n', boxwex=0.4,yaxt='n')
mean_6B<-rep(NA,37)
mean_6B[19]<-mean(box6_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_6B, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la7[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box7_A_hg,ylim=c(0,2000),col='#f7922077', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box7',side=2, line=2.7, las=2)
mean_7A<-rep(NA,37)
mean_7A[19]<-mean(box7_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_7A, col="grey40",bg="grey90",xlab='',ylab='', ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')

plot(rdate[1284:1320],hg$lb7[1284:1320],ylim=c(0,2000),
     type='l', col='#f79220', ylab=' ', lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box7_B_hg,ylim=c(0,2000),col='#f7922077', xaxt='n', boxwex=0.4,yaxt='n')
mean_7B<-rep(NA,37)
mean_7B[19]<-mean(box7_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_7B, col="grey40",bg="grey90", xlab='',ylab='', 
     ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la8[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box8_A_hg,ylim=c(0,2000),col='#f46d4377', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box8',side=2, line=2.7, las=2)
mean_8A<-rep(NA,37)
mean_8A[19]<-mean(box8_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_8A, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')

plot(rdate[1284:1320],hg$lb8[1284:1320],ylim=c(0,2000),
     type='l', col='#f46d43', ylab=' ', lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box8_B_hg,ylim=c(0,2000),col='#f46d4377', xaxt='n', boxwex=0.4,yaxt='n')
mean_8B<-rep(NA,37)
mean_8B[19]<-mean(box8_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_8B, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la9[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box9_A_hg,ylim=c(0,2000),col='#d7302777', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box9',side=2, line=2.7, las=2)
mean_9A<-rep(NA,37)
mean_9A[19]<-mean(box9_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_9A, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')

plot(rdate[1284:1320],hg$lb9[1284:1320],ylim=c(0,2000),
     type='l', col='#d73027', ylab=' ', lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box9_B_hg,ylim=c(0,2000),col='#d7302777', xaxt='n', boxwex=0.4,yaxt='n')
mean_9B<-rep(NA,37)
mean_9B[19]<-mean(box9_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_9B, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
...
plot(rdate[1284:1320],hg$la10[1284:1320],ylim=c(0,2000),
     ...
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box10_A_hg,ylim=c(0,2000),col='#a5002877', xaxt='n', boxwex=0.4,yaxt='n')
mtext(text='box10',side=2, line=2.7, las=2)
mean_10A<-rep(NA,37)
mean_10A[19]<-mean(box10_A_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_10A, col="grey40",bg="grey90", ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')

plot(rdate[1284:1320],hg$lb10[1284:1320],ylim=c(0,2000),
     type='l', col='#a50028', ylab=' ', lwd=2,lty=1,
     xlab= '', cex.lab=1.5, cex.main=1.5,cex.axis=1.2)
par(new=T)
boxplot(box10_B_hg,ylim=c(0,2000),col='#a5002877', xaxt='n', boxwex=0.4,yaxt='n')
mean_10B<-rep(NA,37)
mean_10B[19]<-mean(box10_B_hg$Hg)
par(new=T)
plot(rdate[1284:1320],mean_10B, col="grey40",bg="grey90",ylab  ='',xlab  ='', ylim=c(0,2000),pch=23,cex=1.5,xaxt='n',yaxt='n')
