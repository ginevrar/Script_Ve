...
sand_depo1_1_day<-sand_depos$wn1/d1
sand_depo2_1_day<-sand_depos$wn2/d2
sand_depo3_1_day<-sand_depos$wn3/d3
sand_depo4_1_day<-sand_depos$wn4/d4
sand_depo5_1_day<-sand_depos$wn5/d5
sand_depo6_1_day<-sand_depos$wc6/d6
sand_depo7_1_day<-sand_depos$wc7/d7
sand_depo8_1_day<-sand_depos$ws8/d8
sand_depo9_1_day<-sand_depos$ws9/d9
sand_depo10_1_day<-sand_depos$ws10/d10
...
0.6*area*1.2/10^9 # rough water inventory ug m3*m3
122891*area*0.2/10^12 # rough sediment inventory ug m3*m3 -->ton

122891*area/10^12 *10^-8
...
plot(restot_all[11,]*365/10^9, main='1910 - Res Hg kgy')
plot(deptot_all[11,]*365/10^9, main='1910 - DEp Hg kgy')
