...
setwd('G:\\Il mio Drive\\SHYFEM\\shyfem68_merc\\ireib\\ireib5_120_NOseaBound')
...
#setwd('C:\\Users\\Acer\\Desktop\\nuovi_test\\ireib5_sim47')
#setwd('G:\\Il mio Drive\\SHYFEM\\shyfem68_merc\\ireib\\ireib5_sim52')
setwd('C:\\Users\\Acer\\Desktop\\nuovi_test\\ireib5_120B')
...
str((nodo3985$silt_w))
str((nodo3985_new$silt_w))
#lengthdays<-length(days2)*30/86400
tail(days)
tt1<-nodo3985$it
d1<-tt1/86400
str(d1)
...
dif_per3985<-(nodo3985_new[1000:l2,2:6]-nodo3985[1000:l2,2:6])/nodo3985[1000:l2,2:6]*100
dif_per1372<-(nodo1372_new[1000:l2,2:6]-nodo1372[1000:l2,2:6])/nodo1372[1000:l2,2:6]*100
dif_per2405<-(nodo2405_new[1000:l2,2:6]-nodo2405[1000:l2,2:6])/nodo2405[1000:l2,2:6]*100
dif_per3057<-(nodo3057_new[1000:l2,2:6]-nodo3057[1000:l2,2:6])/nodo3057[1000:l2,2:6]*100
dif_per2654<-(nodo2654_new[1000:l2,2:6]-nodo2654[1000:l2,2:6])/nodo2654[1000:l2,2:6]*100
dif_per2009<-(nodo2009_new[1000:l2,2:6]-nodo2009[1000:l2,2:6])/nodo2009[1000:l2,2:6]*100
dif_per4007<-(nodo4007_new[1000:l2,2:6]-nodo4007[1000:l2,2:6])/nodo4007[1000:l2,2:6]*100
dif_per2341<-(nodo2341_new[1000:l2,2:6]-nodo2341[1000:l2,2:6])/nodo2341[1000:l2,2:6]*100
...
silt_wDif<-c(dif_per3985$silt_w,dif_per1372$silt_w,dif_per2405$silt_w,
           ...
           dif_per2341$silt_w)
silt_wDif<-data.frame(silt_wDif)
POM_wDif<-data.frame(POM_wDif)
plot(dif_per4007$silt_w, type='l')
...
silt_wDif<-subset(silt_wDif, silt_wDif<300)
POM_wDif<-subset(POM_wDif, POM_wDif<300)


png('Hist_diffTCD_44_52.png', width = 21,height = 12, units = 'cm',res=300)
par(mfrow=c(2,1),mar=c(2.9,2.1,1.91,.1), oma=c(0,0,3,0),
    cex.axis=1.2,cex=0.8,lwd=1.4)

hist(-silt_wDif[,], xlab='%',
     main='Differenze (%) tra \n le concentrazioni simulate di Silt')
hist(-POM_wDif[,], xlab='%',
...
png('Differences_ireib5_52_44_tcd.png', width = 29,height = 21, units = 'cm',res=300)
...
str(d2)
str(days2)
plot(ax, nodo2405_new$silt_w, type='l', 
...
png('Confronto_sil_ireib_117_95.png', width = 29,height = 21, units = 'cm',res=300)
par(mfrow=c(2,4),mar=c(2.9,2.1,.1,.1), oma=c(0,0,3,0),
    cex.axis=1.2,cex=1.2,lwd=1.4)

plot(d2, nodo2405_new$silt_w, type='l', 
     col=2, lty=1, ylim=c(0,50), ylab = 'ng/l')
par(new=T)
plot(d1, nodo2405$silt_w[1:length(ax)], 
     type='l', col=1, ylim=c(0,50),ylab = 'ng/l', lty=2)
mtext('VE 01',side=3,cex = 1.3,  col =1)
mtext("silt in water (mg/l)", 3, outer = TRUE, line=1.8, cex=2, font=2)
legend('topright',legend=c(' sim 117','95'),         #'dt = 30','dt = 300'),
       col=c(1,2),lty=c(1),
       pch='-',lwd=1.1,  bty='n')
...
plot(ax, nodo3057$silt_w[1:length(ax)],lty=2,
     type='l', col=1, ylim=c(0,80), ylab = 'ng/l')
...
plot(ax, nodo4007$silt_w[1:length(ax)], 
     type='l',lty=2, col=1, ylim=c(0,100), ylab = 'ng/l')
...
png('Confronto_POM_ireib2_117_95.png', width = 29,height = 21, units = 'cm',res=300)
par(mfrow=c(2,4),mar=c(2.9,2.1,.1,.1), oma=c(0,0,3,0),
    cex.axis=1.2,cex=1.2,lwd=1.4)
...
plot(ax, nodo2405$POM_w[1:length(ax)], 
     type='l', col=1, ylim=c(0,3.0),ylab = 'ng/l', lty=2)
mtext('VE 01',side=3,cex = 1.3,  col =1)
mtext("POM_w in water (ng/l)", 3, outer = TRUE, line=1.8, cex=2, font=2)
legend('topright',legend=c('117','95'),    #legend=c('dt=30 ','dt=300'),
       col=c(1,2),lty=c(1),
       pch='-',lwd=1.1,  bty='n')
...
legend('topright',legend=c('ireib=5 sim 40','ireib=5, sim 42'),          legend=c('dt=30 ','dt=300'),
       col=c(1,2),lty=c(1),
       pch='-',lwd=1.1,  bty='n')
...
9000*3
days[m:l]
png('Confronto_silt_w_sametmstp_1mese_ireib5895_tce_va.png', width = 29,height = 21, units = 'cm',res=300)
par(mfrow=c(2,4),mar=c(2.9,2.1,.1,.1), oma=c(0,0,3,0),
    cex.axis=1.2,cex=1.2,lwd=1.4)
...
plot(days[m:l], nodo2405_new$silt_w[m:l], type='l', 
     col=2, lty=2, ylim=c(0,120), ylab = 'ng/l')
mtext("silt in water (mg/l)", 3, outer = TRUE, line=1.8, cex=2, font=2)
mtext("ng/l", 2, outer = TRUE, line=1.8, cex=1.2)
legend('topright',legend=c('tCD=0.55','tCD=0.75'),
       col=c(1,2),lty=c(1),
       pch='-',lwd=1.1,  bty='n')
mtext('VE 01',side=3,cex = 1.3,  col =1)
...
plot(days[m:l], nodo3057_new$silt_w[m:l], type='l', 
     col=2, lty=2, ylim=c(0,150), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)

plot(days[m:l], nodo1372$silt_w[m:l], type='l', col=1, ylim=c(0,90), ylab = 'ng/l')#20
par(new=T)
plot(days[m:l], nodo1372_new$silt_w[m:l], type='l', col=2, lty=2, 
     ylim=c(0,90), ylab = 'ng/l')#20
mtext('VE 03',side=3,cex = 1.3,  col =1)

plot(days[m:l], nodo2654$silt_w[m:l], type='l', 
     col=1, ylim=c(0,70), ylab = 'ng/l')
par(new=T)
plot(days[m:l], nodo2654_new$silt_w[m:l], type='l', 
     col=2, lty=2, ylim=c(0,70), ylab = 'ng/l')
mtext('VE 04',side=3,cex = 1.3,  col =1)

plot(days[m:l], nodo2341$silt_w[m:l], type='l', col=1, 
     ylim=c(0,90), ylab = 'ng/l')
par(new=T)
plot(days[m:l], nodo2341_new$silt_w[m:l], type='l', col=2, 
     lty=2, ylim=c(0,90), ylab = 'ng/l')
mtext('VE 05',side=3,cex = 1.3,  col =1)


plot(days[m:l], nodo2009$silt_w[m:l], type='l', col=1, 
     ylim=c(0,90),ylab = 'ng/l')
par(new=T)
...
plot(days[m:l], nodo4007$silt_w[m:l], type='l', col=1, 
       ylim=c(0,90), ylab = 'ng/l')
  par(new=T)
...
plot(days[m:l], nodo3985$silt_w[m:l], type='l', col=1, 
     ylim=c(0,90), ylab = 'ng/l')
par(new=T)
