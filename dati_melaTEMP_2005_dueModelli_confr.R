...
mod_b01<-read.table('temp.2d.1')   
mod_b02<-read.table('temp.2d.2')   
mod_b03<-read.table('temp.2d.3')   
mod_b04<-read.table('temp.2d.4')   
mod_b05<-read.table('temp.2d.5')   
mod_b06<-read.table('temp.2d.6')   
mod_b07<-read.table('temp.2d.7')   
mod_b08<-read.table('temp.2d.8')   
mod_b09<-read.table('temp.2d.9')   
mod_b10<-read.table('temp.2d.10')   
mod_b11<-read.table('temp.2d.11')   
mod_b12<-read.table('temp.2d.12')   
mod_b13<-read.table('temp.2d.13')   
mod_b14<-read.table('temp.2d.14')   
mod_b15<-read.table('temp.2d.15')   
mod_b16<-read.table('temp.2d.16')   
mod_b17<-read.table('temp.2d.17')   
mod_b18<-read.table('temp.2d.18')   
mod_b19<-read.table('temp.2d.19')   
mod_b20<-read.table('temp.2d.20')   
mod_b31<-read.table('temp.2d.21')   
mod_CI<-read.table('temp.2d.22')   
mod_CS<-read.table('temp.2d.23')   

setwd('C:/Users/gi/Desktop/shyfem68_merc/File_hydro/ireib2_bis')
mod2_b01<-read.table('temp.2d.1')   
mod2_b02<-read.table('temp.2d.2')   
mod2_b03<-read.table('temp.2d.3')   
mod2_b04<-read.table('temp.2d.4')   
mod2_b05<-read.table('temp.2d.5')   
mod2_b06<-read.table('temp.2d.6')   
mod2_b07<-read.table('temp.2d.7')   
mod2_b08<-read.table('temp.2d.8')   
mod2_b09<-read.table('temp.2d.9')   
mod2_b10<-read.table('temp.2d.10')   
mod2_b11<-read.table('temp.2d.11')   
mod2_b12<-read.table('temp.2d.12')   
mod2_b13<-read.table('temp.2d.13')   
mod2_b14<-read.table('temp.2d.14')   
mod2_b15<-read.table('temp.2d.15')   
mod2_b16<-read.table('temp.2d.16')   
mod2_b17<-read.table('temp.2d.17')   
mod2_b18<-read.table('temp.2d.18')   
mod2_b19<-read.table('temp.2d.19')   
mod2_b20<-read.table('temp.2d.20')   
mod2_b31<-read.table('temp.2d.21')   
mod2_CI<-read.table('temp.2d.22')   
mod2_CS<-read.table('temp.2d.23')   
...
plot(X[23]$C01.Data,X[23]$C01.TEMP, type='p')




png('DatiMElaTEMP2005_model_twosimV.png',width=29, height = 21, units='cm',res=200) 
...
par(new=T)
plot(B01$B01.Data,B01$B01.TEMP, type='p',lwd=2,
     ylab='*C',xlab = '',
     ylim=c(0,35),col='#00000066', pch=19)
mtext('St. B01, nodo 3765',3)
mtext('Temperatura',3, outer=T, line=2,font=2, cex=1.3)
#text((B01$B01.Data,B01$B01.TEMP,labels=B01$B01.TEMP)

plot(as.POSIXct.Date(mod_b02[,1]), mod_b02[,2],ylim=c(0,35),
...
plot(as.POSIXct.Date(mod2_b02[,1]), mod2_b02[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B02$B02.Data,B02$B02.TEMP, type='p',ylim=c(0,35),lwd=2, ylab='*C',xlab = '',
     col='#00000066', pch=19)
mtext('St. B02, nodo 4036',3)

plot(as.POSIXct.Date(mod_b03[,1]), mod_b03[,2],
     ylim=c(0,35),pch=19,ylab='*C',xlab = '',type='l',lwd=1.6,
     xaxt='n',col='#005E8C')
par(new=T)
plot(as.POSIXct.Date(mod2_b03[,1]), mod2_b03[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B03$B03.Data,B03$B03.TEMP, type='p',ylim=c(0,35),lwd=2, ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b04[,1]), mod2_b04[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B04$B04.Data,B04$B04.TEMP, type='p',lwd=2,ylim=c(0,35), ylab='*C',xlab = '',
     col='#00000066', pch=19)
mtext('St. B04, nodo 3549',3)
legend(B01$B01.Data[1]-20.3,38, pch=19,lty=c(2,1,2,4),
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b06[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B06$B06.Data,B06$B06.TEMP, type='p',
     ylim=c(0,35),ylab='*C',xlab = '',lwd=1.5,
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b07[,1]), mod2_b07[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B07$B07.Data,B07$B07.TEMP, lwd=2,type='p',ylim=c(0,35), ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b08[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B08$B08.Data,B08$B08.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b09[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B09$B09.Data,B09$B09.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
mtext('St. B09, nodo 2409',3)

plot(as.POSIXct.Date(mod_b10[,1]), mod_b10[,2],
     ylim=c(0,35),pch=19,ylab=' ',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b10[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B10$B10.Data,B10$B10.TEMP, type='p',lwd=2,
     ylim=c(0,35), ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b10[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B11$B11.Data,B11$B11.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]),mod2_b14[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B14$B14.Data,B14$B14.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b16[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B16$B16.Data,B16$B16.TEMP, type='p',lwd=2,ylim=c(0,35), ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b17[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B17$B17.Data,B17$B17.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b19[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B19$B19.Data,B19$B19.TEMP, type='p',ylim=c(0,35),
     ylab='*C',xlab = '',lwd=1.5,
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b20[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B20$B20.Data,B20$B20.TEMP, type='p',lwd=2,
     ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b31[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B31$B31.Data,B31$B31.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod_CI[,1]), mod_CI[,2],
     ...
     xaxt='n',col='#005E8C',type='l')
par(new=T)
plot(as.POSIXct.Date(mod2_CI[,1]), mod2_CI[,2],type='l',lwd=1.6,lty=2,
     ylim=c(0,35),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='darkorange')
par(new=T)
plot(CI$CI.Data,CI$CI.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
...
plot(as.POSIXct.Date(mod2_CS[,1]), mod2_CS[,2],type='l',lwd=1.6,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(CS$CS.Data,CS$CS.TEMP, type='p',lwd=2,ylim=c(0,35),ylab='*C',xlab = '',
     col='#00000066', pch=19)
