...
str(nodo3985_old); str(nodo3985)
summary(nodo3985_old); summary(nodo3985)
summary(nodo1372_old); summary(nodo1372)
summary(nodo2405_old); summary(nodo2405)
...
lengthdays2<-length(nodo2009_old$Hg2)*100/86400
...
png('Confronto_hg0__9558_l.png', width = 29,height = 21, units = 'cm',res=300)
par(mfrow=c(2,4),mar=c(2.9,2.1,.1,.1), oma=c(0,0,3,0),
    cex.axis=1.2,cex=1.2,lwd=1.4)

plot(days, nodo2405_old$Hgod[1:length(days)], type='l', 
     col=2, lty=1, ylim=c(0,5), ylab = 'ng/l')
par(new=T)
plot(days, nodo2405$Hgod[1:length(days)], 
     type='l', col=1, ylim=c(0,5),ylab = 'ng/l', lty=2)
mtext('VE 01',side=3,cex = 1.3,  col =1)
mtext("Hg0 in water (ng/l)", 3, outer = TRUE, line=1.8, cex=2, font=2)
legend('topright',legend=c('sim95','sim58'),
       col=c(1,2),lty=c(1),
       pch='-',lwd=1.1,  bty='n')

plot(days, nodo3057_old$Hgod[1:length(days)], 
     type='l', col=2, lty=1, ylim=c(0,5), ylab = 'ng/l')
par(new=T)
plot(days, nodo3057$Hgod[1:length(days)],lty=2,
     type='l', col=1, ylim=c(0,5), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)

plot(days2, nodo1372_old$Hgod[1:length(days2)], type='l', col=2,
     lty=1, ylim=c(0,5),ylab = 'ng/l')#20
par(new=T)
plot(days, nodo1372$Hgod[1:length(nodo3985$Hg2)], type='l',
     lty=2,col=1, ylim=c(0,5), 
     ylab = 'ng/l')
...
plot(days2, nodo4007_old$Hgod[1:length(days2)], type='l', col=2, lty=1, ylim=c(0,5), ylab = 'ng/l')
par(new=T)
plot(days, nodo4007$Hgod[1:length(nodo3985$Hg2)], 
     type='l',lty=2, col=1, ylim=c(0,5), ylab = 'ng/l')
mtext('VE 07',side=3,cex = 1.3,  col =1)

plot(days2, nodo3985_old$Hgod[1:length(days2)], type='l', col=2, lty=1, ylim=c(0,5), ylab = 'ng/l')
par(new=T)
...
png('Confronto_mehg_9558l.png', width = 29,height = 21, units = 'cm',res=300)
par(mfrow=c(2,4),mar=c(2.9,2.1,.1,.1), oma=c(0,0,3,0),
    cex.axis=1.2,cex=1.2,lwd=1.4)

plot(days2, nodo2405_old$MeHg[1:length(days2)], type='l', 
     col=2, lty=1, ylim=c(0,1.5), ylab = 'ng/l')
par(new=T)
plot(days, nodo2405$MeHg[1:length(nodo3985$Hg2)], 
     type='l', col=1, ylim=c(0,1.5),ylab = 'ng/l', lty=2)
mtext('VE 01',side=3,cex = 1.3,  col =1)
...
plot(days2, nodo3057_old$MeHg[1:length(days2)], 
     type='l', col=2, lty=1, ylim=c(0,1), ylab = 'ng/l')
par(new=T)
plot(days, nodo3057$MeHg[1:length(nodo3985$Hg2)],lty=2,
     type='l', col=1, ylim=c(0,1), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)
...
plot(days2, nodo2341_old$MeHg[1:length(days2)], type='l', 
     col=2, lty=1, ylim=c(0,.8), ylab = 'ng/l')
par(new=T)
...
plot(days, nodo4007$MeHg[1:length(nodo3985$Hg2)], 
     type='l',lty=2, col=1, ylim=c(0,1), ylab = 'ng/l')
mtext('VE 07',side=3,cex = 1.3,  col =1)

plot(days2, nodo3985_old$MeHg[1:length(days2)], type='l', col=2, lty=1, ylim=c(0,1), ylab = 'ng/l')
par(new=T)
...
png('Confronto_hg2_9558l.png', width = 29,height = 21, units = 'cm',res=300)
par(mfrow=c(2,4),mar=c(2.9,2.1,.1,.1), oma=c(0,0,3,0),
    cex.axis=1.2,cex=1.2,lwd=1.4)


plot(days2, nodo2405_old$Hg2[1:length(days2)], type='l', 
     col=2, lty=1, ylim=c(0,30), ylab = 'ng/l')
par(new=T)
plot(days, nodo2405$Hg2[1:length(nodo3985$Hg2)], 
     type='l', col=1, ylim=c(0,30),ylab = 'ng/l', lty=2)
mtext('VE 01',side=3,cex = 1.3,  col =1)
...
plot(days, nodo3057$Hg2[1:length(nodo3985$Hg2)],lty=2,
     type='l', col=1, ylim=c(0,30), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)
...
plot(days, nodo2654$Hg2[1:length(nodo3985$Hg2)], lty=2,
     type='l', col=1, ylim=c(0,20), ylab = 'ng/l')
mtext('VE 04',side=3,cex = 1.3,  col =1)
...
plot(days, nodo4007$Hg2[1:length(nodo3985$Hg2)], 
     type='l',lty=2, col=1, ylim=c(0,20), ylab = 'ng/l')
mtext('VE 07',side=3,cex = 1.3,  col =1)
...
plot(days2, nodo3985_old$Hg2[1:length(days2)], type='l', 
     col=2, lty=1, ylim=c(0,890), ylab = 'ng/l')
par(new=T)
plot(days, nodo3985$Hg2[1:length(nodo3985$Hg2)], type='l',lty=2,
     col=1, ylim=c(0,890), ylab = 'ng/l')
mtext('VE 08',side=3,cex = 1.3,  col =1)

par(mfrow=c(1,1))
plot(days2, nodo4007_old$Hg2[1:length(days2)], ylim=c(0,29000),
     type='l', col=2, lty=1)  #, ylim=c(0,30), ylab = 'ng/l')
par(new=T)
plot(days, nodo4007$Hg2[1:length(nodo3985$Hg2)],lty=2,ylim=c(0,29000),
     type='l', col=1 )     #,  ylim=c(0,30), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)

plot(days2, nodo3057_old$MeHg[1:length(days2)], ylim=c(0,15000),
     type='l', col=2, lty=1)  #, ylim=c(0,30), ylab = 'ng/l')
par(new=T)
plot(days, nodo3057$MeHg[1:length(nodo3985$Hg2)],lty=2,ylim=c(0,15000),
     type='l', col=1 )     #,  ylim=c(0,30), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)


plot(days2, nodo2405_old$Hgod[1:length(days2)], ylim=c(0,5000),main='Hg0 sim 80-81',
     type='l', col=2, lty=1)  #, ylim=c(0,30), ylab = 'ng/l')
par(new=T)
plot(days, nodo2405$Hgod[1:length(nodo3985$Hg2)],lty=2,ylim=c(0,5000),
     type='l', col=1 )     #,  ylim=c(0,30), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)
...
par(mfrow=c(1,1))
plot(days2[1:21900], nodo3057_old$Hg2[1:21900], ylim=c(0,27000),
     type='l', col=2, lty=1)  #, ylim=c(0,30), ylab = 'ng/l')
par(new=T)
plot(days[1:21900], nodo3057$Hg2[1:21900],lty=2,ylim=c(0,570),
     type='l', col=1 )     #,  ylim=c(0,30), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)
getwd()


plot(days[1:21900], nodo3057$Hg2[1:21900],lty=2, 
     type='l', col=1 )     #,  ylim=c(0,30), ylab = 'ng/l')
mtext('VE 02',side=3,cex = 1.3,  col =1)
