...
setwd('C:\\Users\\Acer\\Desktop\\nuovi_test\\ireib5_sim40')
setwd('G:\\Il mio Drive\\SHYFEM\\shyfem68_merc\\ireib\\ireib2_sim37')
...
setwd('G:\\Il mio Drive\\SHYFEM\\shyfem68_merc\\ireib\\lag64_simB')
...
str(mod_b01[7776:8761,1])
ax<-as.POSIXct(mod_b01[7776:8761,1],format='%Y/%m/%d::%H:%M:%S')

png('DatiMEla_SOM_2005_model_twosimVer_ireib5_2_sim37_B_ireib2.png',width=29, height = 21, units='cm',res=200) 
...
plot(as.POSIXct.Date(mod_b01[7776:8761,1]), mod_b01[7776:8761,2],type='l',lwd=2,
...
plot(as.POSIXct.Date(mod_b02[7776:8761,1]), mod_b02[7776:8761,2],ylim=c(0,40),
...
plot(as.POSIXct.Date(mod_b03[7776:8761,1]), mod_b03[7776:8761,2],
...
plot(as.POSIXct.Date(mod_b04[7776:8761,1]),mod_b04[7776:8761,2],
     ylim=c(0,100),pch=19,ylab='*C',xlab = '',
...
plot(as.POSIXct.Date(mod_b06[7776:8761,1]), mod_b06[7776:8761,2],
     ylim=c(0,120),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
...
plot(as.POSIXct.Date(mod_b07[7776:8761,1]), mod_b07[7776:8761,2],
...
plot(as.POSIXct.Date(mod_b08[7776:8761,1]), mod_b08[7776:8761,2],
...
plot(as.POSIXct.Date(mod_b09[7776:8761,1]), mod_b09[7776:8761,2],
...
plot(as.POSIXct.Date(mod_b10[7776:8761,1]), mod_b10[7776:8761,2],
     ylim=c(0,80),pch=19,ylab=' ',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
...
plot(B10$B10.Data,B10$B10.TSS,cex=1.5, type='p',lwd=2,
     ylim=c(0,80), ylab='*C',xlab = '',
     col='#00000099', pch=19)
mtext('St. B10, nodo 2095',3)

plot(as.POSIXct.Date(mod_b11[7776:8761,1]), mod_b11[7776:8761,2],
     ylim=c(0,120),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
plot(as.POSIXct.Date(mod2_b01[,1]), mod2_b11[,2],type='l',lwd=2,lty=2,
     ...
     xaxt='n',col='darkorange')
par(new=T)
plot(B11$B11.Data,B11$B11.TSS,cex=1.5, type='p',lwd=2,ylim=c(0,120),ylab='*C',xlab = '',
     col='#00000099', pch=19)
mtext('St. B11, nodo 2419',3)


plot(as.POSIXct.Date(mod_b14[7776:8761,1]), mod_b14[7776:8761,2],
     ylim=c(0,40),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
...
plot(as.POSIXct.Date(mod_b16[7776:8761,1]), mod_b16[7776:8761,2],
...
plot(as.POSIXct.Date(mod_b17[7776:8761,1]), mod_b17[7776:8761,2],
     ylim=c(0,130),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
...
plot(as.POSIXct.Date(mod_b19[7776:8761,1]), mod_b19[7776:8761,2],
...
plot(as.POSIXct.Date(mod_b20[7776:8761,1]), mod_b20[7776:8761,2],
     ylim=c(0,40),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
...
plot(as.POSIXct.Date(mod_b31[7776:8761,1]), mod_b31[7776:8761,2],
...
plot(as.POSIXct.Date(mod_CI[7776:8761,1]), mod_CI[7776:8761,2],
...
plot(as.POSIXct.Date(mod_CS[7776:8761,1]), mod_CS[7776:8761,2],
     ylim=c(0,30),pch=19,ylab='*C',xlab = '',
     xaxt='n',col='#005E8C',type='l')
par(new=T)
